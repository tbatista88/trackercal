(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))o(r);new MutationObserver(r=>{for(const v of r)if(v.type==="childList")for(const $ of v.addedNodes)$.tagName==="LINK"&&$.rel==="modulepreload"&&o($)}).observe(document,{childList:!0,subtree:!0});function e(r){const v={};return r.integrity&&(v.integrity=r.integrity),r.referrerPolicy&&(v.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?v.credentials="include":r.crossOrigin==="anonymous"?v.credentials="omit":v.credentials="same-origin",v}function o(r){if(r.ep)return;r.ep=!0;const v=e(r);fetch(r.href,v)}})();const P={PROFILE:"tcv2_profile",PRODUCTS:"tcv2_products",CONSUMPTIONS:"tcv2_consumptions",SETTINGS:"tcv2_settings"};function re(){return Date.now().toString(36)+Math.random().toString(36).substr(2,9)}function U(t,n=null){try{const e=localStorage.getItem(t);return e?JSON.parse(e):n}catch{return n}}function F(t,n){localStorage.setItem(t,JSON.stringify(n))}function pe(){return new Date().toISOString().split("T")[0]}const A={};function X(t,n){return A[t]||(A[t]=[]),A[t].push(n),()=>{A[t]=A[t].filter(e=>e!==n)}}function I(t,n){A[t]&&A[t].forEach(e=>e(n))}function W(){return U(P.PROFILE,null)}function le(t){const n={...t,updatedAt:new Date().toISOString()};return F(P.PROFILE,n),I("profile:updated",n),n}function ce(){return W()!==null}function V(){return U(P.PRODUCTS,[])}function N(t){return V().find(n=>n.id===t)||null}function ee(t){const n=V(),e={id:re(),name:t.name||"",description:t.description||"",caloriesPer100g:parseFloat(t.caloriesPer100g)||0,photo:t.photo||null,createdAt:new Date().toISOString()};return n.unshift(e),F(P.PRODUCTS,n),I("products:updated",n),e}function me(t,n){const e=V(),o=e.findIndex(r=>r.id===t);return o===-1?null:(e[o]={...e[o],...n,updatedAt:new Date().toISOString()},F(P.PRODUCTS,e),I("products:updated",e),e[o])}function ve(t){const n=V().filter(e=>e.id!==t);F(P.PRODUCTS,n),I("products:updated",n)}function O(t=null){const n=U(P.CONSUMPTIONS,[]);return t?n.filter(e=>e.date===t):n}function ge(t){const n=O(),e={id:re(),productId:t.productId||null,productNameBackup:t.productNameBackup||"",productPhotoBackup:t.productPhotoBackup||null,caloriesPer100gBackup:t.caloriesPer100gBackup||0,grams:parseFloat(t.grams)||0,calories:parseFloat(t.calories)||0,meal:t.meal||"collation",notes:t.notes||"",date:t.date||pe(),createdAt:new Date().toISOString()};return n.unshift(e),F(P.CONSUMPTIONS,n),I("consumptions:updated",n),e}function be(t){const n=O().filter(e=>e.id!==t);F(P.CONSUMPTIONS,n),I("consumptions:updated",n)}function fe(t,n){return O().filter(o=>o.date>=t&&o.date<=n)}function Z(){return U(P.SETTINGS,{theme:"light",notifications:!1})}function he(t){const n={...Z(),...t};return F(P.SETTINGS,n),I("settings:updated",n),n}function J(){return Z().theme||"light"}function ye(t){he({theme:t}),document.documentElement.setAttribute("data-theme",t)}function xe(t){const n=W(),e=O(t),o=e.reduce((k,b)=>k+b.calories,0),r=(n==null?void 0:n.dailyTarget)||0,v={"petit-dejeuner":[],dejeuner:[],diner:[],collation:[]};e.forEach(k=>{const b=k.meal||"collation";v[b]?v[b].push(k):v.collation.push(k)});const $={"petit-dejeuner":"🌅 Petit-déjeuner",dejeuner:"☀️ Déjeuner",diner:"🌙 Dîner",collation:"🍪 Collation"};let y=`📊 Mon Suivi Calories – ${t}
`;y+=`━━━━━━━━━━━━━━━━━━━━
`,y+=`🎯 Objectif : ${Math.round(r)} kcal
`,y+=`📈 Consommé : ${Math.round(o)} kcal
`,y+=`${o<=r?"✅":"⚠️"} ${o<=r?"Objectif respecté !":"Objectif dépassé !"}

`;for(const[k,b]of Object.entries(v))b.length!==0&&(y+=`${$[k]}
`,b.forEach(E=>{y+=`  • ${E.productNameBackup} – ${E.grams}g – ${Math.round(E.calories)} kcal
`}),y+=`
`);return y}function we(){Object.values(P).forEach(t=>localStorage.removeItem(t)),I("data:cleared")}function Se(t,n,e,o){const r=10*e+6.25*o-5*t;return n==="homme"?r+5:r-161}function $e(t,n="sedentary"){return t*({sedentary:1.2,light:1.375,moderate:1.55,active:1.725,"very-active":1.9}[n]||1.2)}function Q(t){const{age:n,sex:e,weight:o,height:r,goalWeight:v,duration:$,activityLevel:y}=t,k=Se(n,e,o,r||170),b=$e(k,y||"sedentary"),E=o-v,u=$*30;let p=0;E>0&&u>0&&(p=E*7700/u);let l=b-p;return l<1200&&(l=1200),l>b+1e3&&(l=b+1e3),{bmr:Math.round(k),tdee:Math.round(b),dailyDeficit:Math.round(p),dailyTarget:Math.round(l)}}function te(t,n){return t*n/100}function ae(t){return t*.23900573614}let _=null;function ke(){return _||(_=document.createElement("div"),_.className="toast-container",document.body.appendChild(_)),_}function L(t,n="info",e=3e3){const o={success:"✅",error:"❌",warning:"⚠️",info:"ℹ️"},r=document.createElement("div");r.className="toast",r.innerHTML=`
    <span class="toast-icon">${o[n]||o.info}</span>
    <span class="toast-message">${t}</span>
  `,ke().appendChild(r),setTimeout(()=>{r.style.animation="fadeOut 0.3s ease forwards",setTimeout(()=>r.remove(),300)},e)}const G=[{id:"welcome",title:"Bienvenue ! 🌸",subtitle:"Configurons votre profil pour calculer votre objectif calorique quotidien."},{id:"basics",title:"Informations de base",subtitle:"Ces données nous aident à calculer votre métabolisme."},{id:"goals",title:"Votre objectif",subtitle:"Définissez votre poids cible et la durée souhaitée."},{id:"summary",title:"Votre plan",subtitle:"Voici votre objectif calorique calculé."}];function Ee(t){let n=0,e={age:"",sex:"femme",weight:"",height:"170",goalWeight:"",duration:"3",activityLevel:"sedentary"};function o(){const l=G[n];t.innerHTML=`
      <div class="onboarding">
        <div class="onboarding-header">
          <div class="onboarding-progress">
            ${G.map((d,c)=>`
              <div class="onboarding-dot ${c<=n?"active":""}"></div>
            `).join("")}
          </div>
        ...
        <div class="onboarding-footer">
          ...
          ${n<G.length-1?'<button class="btn btn-primary" id="btn-next">Suivant →</button>':'<button class="btn btn-primary btn-lg" id="btn-finish">🚀 Commencer !</button>'}
        </div>
      </div>
    `,E()}function r(){switch(n){case 0:return v();case 1:return $();case 2:return y();case 3:return k();default:return""}}function v(){return`
    ...
    `}function b(){const l={"onb-age":"age","onb-height":"height","onb-weight":"weight","onb-goal":"goalWeight","onb-duration":"duration"};for(const[d,c]of Object.entries(l)){const s=t.querySelector(`#${d}`);s&&(e[c]=s.value)}}function E(){t.querySelectorAll("[data-sex]").forEach(a=>{a.addEventListener("click",()=>{b(),e.sex=a.dataset.sex,o()})}),t.querySelectorAll("[data-activity]").forEach(a=>{a.addEventListener("click",()=>{b(),e.activityLevel=a.dataset.activity,o()})});const l={"onb-age":"age","onb-height":"height","onb-weight":"weight","onb-goal":"goalWeight","onb-duration":"duration"};for(const[a,i]of Object.entries(l)){const g=t.querySelector(`#${a}`);g&&g.addEventListener("input",()=>{e[i]=g.value})}const d=t.querySelector("#btn-next"),c=t.querySelector("#btn-prev"),s=t.querySelector("#btn-finish");d&&d.addEventListener("click",()=>{b(),u()&&(n++,o())}),c&&c.addEventListener("click",()=>{b(),n--,o()}),s&&s.addEventListener("click",()=>{b(),p()})}function u(){switch(n){case 1:return!e.age||parseInt(e.age)<15?(L("Veuillez entrer un âge valide (15+)","warning"),!1):!e.weight||parseFloat(e.weight)<30?(L("Veuillez entrer un poids valide","warning"),!1):!0;case 2:return!e.goalWeight||parseFloat(e.goalWeight)<30?(L("Veuillez entrer un objectif de poids valide","warning"),!1):!e.duration||parseInt(e.duration)<1?(L("Veuillez entrer une durée valide (minimum 1 mois)","warning"),!1):!0;default:return!0}}function p(){const l=Q({age:parseInt(e.age),sex:e.sex,weight:parseFloat(e.weight),height:parseInt(e.height)||170,goalWeight:parseFloat(e.goalWeight),duration:parseInt(e.duration),activityLevel:e.activityLevel});le({...e,age:parseInt(e.age),weight:parseFloat(e.weight),height:parseInt(e.height)||170,goalWeight:parseFloat(e.goalWeight),duration:parseInt(e.duration),bmr:l.bmr,tdee:l.tdee,dailyDeficit:l.dailyDeficit,dailyTarget:l.dailyTarget}),L("Profil créé avec succès ! 🎉","success")}return o(),()=>{}}const ne={"petit-dejeuner":{icon:"🌅",label:"Petit-déjeuner"},dejeuner:{icon:"☀️",label:"Déjeuner"},diner:{icon:"🌙",label:"Dîner"},collation:{icon:"🍪",label:"Collation"}};function se(t){const n=W(),e=new Date().toISOString().split("T")[0];let o=e;const r=[];function v(){const u=O(o),p=u.reduce((x,h)=>x+(h.calories||0),0),l=(n==null?void 0:n.dailyTarget)||2e3,d=Math.min(p/l*100,100),c=p>l,s=l-p,a={};for(const x of Object.keys(ne))a[x]=u.filter(h=>h.meal===x);const i=new Date(o+"T12:00:00"),g=o===e,f=g?"Aujourd'hui":i.toLocaleDateString("fr-FR",{weekday:"long",day:"numeric",month:"long"}),m=2*Math.PI*54,w=m-d/100*m;t.innerHTML=`
      <div class="dashboard">
        ...
        <div class="dashboard-ring-section ${c?"over-target-glow":""}" style="text-align:center;padding:var(--space-md);">
          ...
          <div class="flex-center gap-lg" style="margin-top:var(--space-md);">
            <div style="text-align:center;">
              <div style="font-size:var(--font-2xl);font-weight:var(--fw-bold);color:${c?"var(--danger)":s>0?"var(--success)":"var(--text-primary)"};">
                ${c?"+":""}${Math.abs(Math.round(s))}
              </div>
        ...
        <div class="dashboard-meals" style="padding:0 var(--space-md);">
          ${Object.entries(ne).map(([x,h])=>{const S=a[x]||[],q=S.reduce((D,T)=>D+(T.calories||0),0);return`
              <div class="meal-group card-glass" style="margin-bottom:var(--space-sm);">
                <div class="meal-group-header" data-meal-toggle="${x}">
                  <span class="meal-group-title">${h.icon} ${h.label}</span>
    ...
    `,y()}function $(u){const p=u.productId?N(u.productId):null,l=(p==null?void 0:p.photo)||u.productPhotoBackup,d=(p==null?void 0:p.name)||u.productNameBackup||"Produit inconnu";return`
    ...
    `}function y(){var u,p,l,d,c;(u=t.querySelector("#btn-date-prev"))==null||u.addEventListener("click",()=>{const s=new Date(o+"T12:00:00");s.setDate(s.getDate()-1),o=s.toISOString().split("T")[0],v()}),(p=t.querySelector("#btn-date-next"))==null||p.addEventListener("click",()=>{const s=new Date(o+"T12:00:00");s.setDate(s.getDate()+1);const a=s.toISOString().split("T")[0];a<=e&&(o=a,v())}),(l=t.querySelector("#btn-date-today"))==null||l.addEventListener("click",()=>{o=e,v()}),(d=t.querySelector("#btn-add-food"))==null||d.addEventListener("click",()=>{R("products",["select"])}),t.querySelectorAll("[data-add-meal]").forEach(s=>{s.addEventListener("click",()=>{const a=s.dataset.addMeal;R("products",["select",a])})}),(c=t.querySelector("#btn-export"))==null||c.addEventListener("click",()=>{const s=xe(o);if(navigator.clipboard)navigator.clipboard.writeText(s).then(()=>{L("Résumé copié dans le presse-papiers ! 📋","success")});else{const a=document.createElement("textarea");a.value=s,document.body.appendChild(a),a.select(),document.execCommand("copy"),document.body.removeChild(a),L("Résumé copié ! 📋","success")}}),t.querySelectorAll("[data-edit-consumption]").forEach(s=>{s.addEventListener("click",a=>{a.stopPropagation();const i=s.dataset.editConsumption;k(i)})}),t.querySelectorAll("[data-delete-consumption]").forEach(s=>{s.addEventListener("click",a=>{a.stopPropagation();const i=s.dataset.deleteConsumption;confirm("Supprimer ce repas ?")&&(be(i),L("Repas supprimé","info"),v())})})}function k(u){const{getConsumption:p}=b(),l=p(u);if(!l)return;const d=l.productId?N(l.productId):null,c=l.productId&&!d,s=(d==null?void 0:d.name)||l.productNameBackup||"Produit inconnu",a=(d==null?void 0:d.caloriesPer100g)||l.caloriesPer100gBackup||0,i=document.createElement("div");i.className="modal-overlay",i.innerHTML=`
    ...
    `,document.body.appendChild(i);const g=i.querySelector("#edit-grams"),f=i.querySelector("#edit-cal-preview");g&&f&&!c&&g.addEventListener("input",()=>{const w=parseFloat(g.value)||0;f.textContent=Math.round(a*w/100)+" kcal"});const m=()=>i.remove();i.querySelector("#modal-close-edit").addEventListener("click",m),i.addEventListener("click",w=>{w.target===i&&m()}),i.querySelector("#btn-save-edit").addEventListener("click",()=>{parseFloat(g.value),i.querySelector("#edit-notes").value,c&&parseFloat(i.querySelector("#edit-calories").value),L("Consommation modifiée ✅","success"),m(),v()})}function b(){return{getConsumption:u=>O().find(p=>p.id===u),updateConsumption:(u,p)=>{},getProduct:N}}const E=X("consumptions:updated",()=>v());return r.push(E),v(),()=>{r.forEach(u=>u())}}const Le="modulepreload",De=function(t){return"/trackercal/"+t},oe={},de=function(n,e,o){let r=Promise.resolve();if(e&&e.length>0){let $=function(b){return Promise.all(b.map(E=>Promise.resolve(E).then(u=>({status:"fulfilled",value:u}),u=>({status:"rejected",reason:u}))))};document.getElementsByTagName("link");const y=document.querySelector("meta[property=csp-nonce]"),k=(y==null?void 0:y.nonce)||(y==null?void 0:y.getAttribute("nonce"));r=$(e.map(b=>{if(b=De(b),b in oe)return;oe[b]=!0;const E=b.endsWith(".css"),u=E?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${b}"]${u}`))return;const p=document.createElement("link");if(p.rel=E?"stylesheet":Le,E||(p.as="script"),p.crossOrigin="",p.href=b,k&&p.setAttribute("nonce",k),document.head.appendChild(p),E)return new Promise((l,d)=>{p.addEventListener("load",l),p.addEventListener("error",()=>d(new Error(`Unable to preload CSS for ${b}`)))})}))}function v($){const y=new Event("vite:preloadError",{cancelable:!0});if(y.payload=$,window.dispatchEvent(y),!y.defaultPrevented)throw $}return r.then($=>{for(const y of $||[])y.status==="rejected"&&v(y.reason);return n().catch(v)})};async function Pe(t){try{const n=await fetch(`https://world.openfoodfacts.org/api/v2/product/${t}`,{headers:{"User-Agent":"MonSuiviCalories/1.0"}});if(!n.ok)return null;const e=await n.json();if(e.status!==1||!e.product)return null;const o=e.product;let r=0;const v=o.nutriments||{};return v["energy-kcal_100g"]?r=parseFloat(v["energy-kcal_100g"]):v["energy-kcal"]?r=parseFloat(v["energy-kcal"]):v.energy_100g?r=Math.round(ae(parseFloat(v.energy_100g))):v.energy&&(r=Math.round(ae(parseFloat(v.energy)))),{name:o.product_name||o.product_name_fr||"Produit inconnu",image:o.image_front_url||o.image_front_small_url||null,caloriesPer100g:Math.round(r),brand:o.brands||"",barcode:t}}catch(n){return console.error("Erreur API Open Food Facts:",n),null}}function qe(t,n=[]){const e=n[0]==="select",o=n[1]||null;let r="";const v=[];function $(){const s=V(),a=r?s.filter(i=>i.name.toLowerCase().includes(r.toLowerCase())):s;t.innerHTML=`
    ...
    `}function k(){var a,i,g;const s=t.querySelector("#product-search");s&&s.addEventListener("input",f=>{r=f.target.value,$();const m=t.querySelector("#product-search");m&&(m.focus(),m.setSelectionRange(r.length,r.length))}),(a=t.querySelector("#btn-back-dash"))==null||a.addEventListener("click",()=>{R("dashboard")}),(i=t.querySelector("#btn-add-product"))==null||i.addEventListener("click",()=>{b()}),(g=t.querySelector("#btn-scan-barcode"))==null||g.addEventListener("click",()=>{u()}),t.querySelectorAll(".product-card").forEach(f=>{f.addEventListener("click",m=>{if(m.target.closest("[data-edit-product]")||m.target.closest("[data-delete-product]"))return;const w=f.dataset.productId;e&&E(w)})}),t.querySelectorAll("[data-edit-product]").forEach(f=>{f.addEventListener("click",m=>{m.stopPropagation(),b(f.dataset.editProduct)})}),t.querySelectorAll("[data-delete-product]").forEach(f=>{f.addEventListener("click",m=>{m.stopPropagation(),confirm("Supprimer ce produit ? Les consommations associées seront conservées.")&&(ve(f.dataset.deleteProduct),L("Produit supprimé","info"),$())})})}function b(s=null){const a=s?N(s):null,i=document.createElement("div");i.className="modal-overlay",i.innerHTML=`
      <div class="modal-content">
        <div class="modal-handle"></div>
    ...
    `,document.body.appendChild(i);let g=(a==null?void 0:a.photo)||null;const f=i.querySelector("#photo-input"),m=i.querySelector("#photo-upload-area");f.addEventListener("change",x=>{const h=x.target.files[0];if(!h)return;const S=new FileReader;S.onload=q=>{const D=new Image;D.onload=()=>{const T=document.createElement("canvas"),z=400;let M=D.width,C=D.height;M>C?M>z&&(C*=z/M,M=z):C>z&&(M*=z/C,C=z),T.width=M,T.height=C,T.getContext("2d").drawImage(D,0,0,M,C),g=T.toDataURL("image/jpeg",.7);let B=m.querySelector("img");B||(B=document.createElement("img"),m.appendChild(B)),B.src=g,B.alt="Photo",m.querySelector(".photo-upload-icon").style.display="none",m.querySelector(".photo-upload-text").style.display="none"},D.src=q.target.result},S.readAsDataURL(h)});const w=()=>i.remove();i.querySelector("#modal-close-product").addEventListener("click",w),i.addEventListener("click",x=>{x.target===i&&w()}),i.querySelector("#btn-save-product").addEventListener("click",()=>{const x=i.querySelector("#prod-name").value.trim(),h=i.querySelector("#prod-desc").value.trim(),S=parseFloat(i.querySelector("#prod-cal").value);if(!x){L("Veuillez entrer un nom","warning");return}if(isNaN(S)||S<0){L("Veuillez entrer des calories valides","warning");return}a?(me(s,{name:x,description:h,caloriesPer100g:S,photo:g}),L("Produit modifié ✅","success")):(ee({name:x,description:h,caloriesPer100g:S,photo:g}),L("Produit ajouté au catalogue ! 🎉","success")),w(),$()})}function E(s){const a=N(s);if(!a)return;const i=document.createElement("div");i.className="modal-overlay",i.innerHTML=`
      <div class="modal-content">
        <div class="modal-handle"></div>
    ...
    `,document.body.appendChild(i);let g=o||"collation";const f=i.querySelector("#cons-grams"),m=i.querySelector("#cal-preview");function w(){const h=parseFloat(f.value)||0,S=te(a.caloriesPer100g,h);m.textContent=Math.round(S)}f.addEventListener("input",w),i.querySelectorAll("[data-quick-gram]").forEach(h=>{h.addEventListener("click",()=>{f.value=h.dataset.quickGram,i.querySelectorAll(".btn-quick-gram").forEach(S=>S.classList.remove("active")),h.classList.add("active"),w()})}),i.querySelectorAll("[data-meal]").forEach(h=>{h.addEventListener("click",()=>{g=h.dataset.meal,i.querySelectorAll("[data-meal]").forEach(S=>S.classList.remove("active")),h.classList.add("active")})});const x=()=>i.remove();i.querySelector("#modal-close-consumption").addEventListener("click",x),i.addEventListener("click",h=>{h.target===i&&x()}),i.querySelector("#btn-confirm-consumption").addEventListener("click",()=>{const h=parseFloat(f.value)||0;if(h<=0){L("Veuillez entrer une quantité valide","warning");return}const S=te(a.caloriesPer100g,h),q=i.querySelector("#cons-notes").value.trim();ge({productId:a.id,productNameBackup:a.name,productPhotoBackup:a.photo,caloriesPer100gBackup:a.caloriesPer100g,grams:h,calories:S,meal:g,notes:q}),L(`${a.name} – ${Math.round(S)} kcal ajouté ! ✅`,"success"),x(),R("dashboard")})}async function u(){let s;try{s=(await de(()=>import("./index-C7szoz8K.js"),[])).Html5Qrcode}catch{L("Scanner non disponible","error"),p();return}const a=document.createElement("div");a.className="modal-overlay",a.style.alignItems="center",a.innerHTML=`
    ...
    `,document.body.appendChild(a);const i=new s("scanner-container");let g=!0;const f=()=>{g=!1,i.stop().catch(()=>{}),a.remove()};a.querySelector("#modal-close-scanner").addEventListener("click",f),a.addEventListener("click",m=>{m.target===a&&f()}),a.querySelector("#btn-manual-barcode").addEventListener("click",()=>{f(),p()});try{await i.start({facingMode:"environment"},{fps:10,qrbox:{width:250,height:100},aspectRatio:1},async m=>{g&&(g=!1,await i.stop(),f(),await l(m))})}catch(m){console.error("Scanner error:",m),f(),L("Impossible d'accéder à la caméra","error"),p()}}function p(){const s=document.createElement("div");s.className="modal-overlay",s.innerHTML=`
      <div class="modal-content">
        <div class="modal-handle"></div>
    ...
    `,document.body.appendChild(s);const a=()=>s.remove();s.querySelector("#modal-close-manual").addEventListener("click",a),s.addEventListener("click",i=>{i.target===s&&a()}),s.querySelector("#btn-search-barcode").addEventListener("click",async()=>{const i=s.querySelector("#manual-barcode").value.trim();if(!i){L("Veuillez entrer un code-barres","warning");return}a(),await l(i)})}async function l(s){L("Recherche en cours...","info",2e3);const a=await Pe(s);if(!a){L("Produit non trouvé dans la base Open Food Facts","error");return}d(a)}function d(s){const a=document.createElement("div");a.className="modal-overlay",a.innerHTML=`
      <div class="modal-content">
        <div class="modal-handle"></div>
    ...
    `,document.body.appendChild(a);const i=()=>a.remove();a.querySelector("#modal-close-result").addEventListener("click",i),a.addEventListener("click",g=>{g.target===a&&i()}),a.querySelector("#btn-add-barcode-product").addEventListener("click",()=>{ee({name:s.name,description:s.brand||"",caloriesPer100g:s.caloriesPer100g,photo:s.image||null}),L("Produit ajouté au catalogue ! 🎉","success"),i(),$()})}const c=X("products:updated",()=>$());return v.push(c),$(),()=>{v.forEach(s=>s())}}function Me(t){const n=W(),e=(n==null?void 0:n.dailyTarget)||2e3;let o="jour",r=null;function v(){t.innerHTML=`
    ...
    `,$(),b(),E()}function $(){t.querySelectorAll("[data-filter]").forEach(u=>{u.addEventListener("click",()=>{o=u.dataset.filter,v()})})}function y(){const u=new Date;u.setHours(12,0,0,0);let p,l;switch(o){case"jour":{p=new Date(u),p.setDate(p.getDate()-6),l=new Date(u);break}case"semaine":{p=new Date(u),p.setDate(p.getDate()-27),l=new Date(u);break}case"mois":{p=new Date(u),p.setMonth(p.getMonth()-5),p.setDate(1),l=new Date(u);break}}return{start:p.toISOString().split("T")[0],end:l.toISOString().split("T")[0]}}function k(){const{start:u,end:p}=y(),l=fe(u,p),d={};if(l.forEach(c=>{d[c.date]||(d[c.date]=0),d[c.date]+=c.calories||0}),o==="jour"){const c=[],s=[],a=new Date;a.setHours(12,0,0,0);for(let i=6;i>=0;i--){const g=new Date(a);g.setDate(g.getDate()-i);const f=g.toISOString().split("T")[0],m=g.toLocaleDateString("fr-FR",{weekday:"short",day:"numeric"});c.push(m),s.push(Math.round(d[f]||0))}return{labels:c,values:s}}if(o==="semaine"){const c=[],s=[],a=new Date;a.setHours(12,0,0,0);for(let i=3;i>=0;i--){const g=new Date(a);g.setDate(g.getDate()-i*7);const f=new Date(g);f.setDate(f.getDate()-6);let m=0,w=0;for(let S=0;S<=6;S++){const q=new Date(f);q.setDate(q.getDate()+S);const D=q.toISOString().split("T")[0];d[D]&&(m+=d[D],w++)}const x=w>0?Math.round(m/w):0,h=f.toLocaleDateString("fr-FR",{day:"numeric",month:"short"});c.push(`Sem. ${h}`),s.push(x)}return{labels:c,values:s}}if(o==="mois"){const c=[],s=[],a=new Date;for(let i=5;i>=0;i--){const g=new Date(a.getFullYear(),a.getMonth()-i,1),f=new Date(a.getFullYear(),a.getMonth()-i+1,0);let m=0,w=0;for(let h=1;h<=f.getDate();h++){const S=`${g.getFullYear()}-${String(g.getMonth()+1).padStart(2,"0")}-${String(h).padStart(2,"0")}`;d[S]&&(m+=d[S],w++)}const x=w>0?Math.round(m/w):0;c.push(g.toLocaleDateString("fr-FR",{month:"short"})),s.push(x)}return{labels:c,values:s}}return{labels:[],values:[]}}async function b(){const u=t.querySelector("#calorie-chart");if(!u)return;const{labels:p,values:l}=k();let d;try{const m=await de(()=>import("./chart-45xamTTr.js"),[]);d=m.Chart;const{CategoryScale:w,LinearScale:x,BarElement:h,LineElement:S,PointElement:q,Title:D,Tooltip:T,Legend:z,BarController:M,LineController:C}=m;d.register(w,x,h,S,q,D,T,z,M,C)}catch(m){console.error("Chart.js not available:",m),u.parentElement.innerHTML='<p style="text-align:center;color:var(--text-tertiary);padding:var(--space-lg);">Graphique non disponible</p>';return}r&&r.destroy();const c=u.getContext("2d");l.map(m=>m>e);const s=getComputedStyle(document.documentElement),a=s.getPropertyValue("--text-secondary").trim()||"#6B4D5A",i=s.getPropertyValue("--accent").trim()||"#E91E8C",g="#F44336",f=s.getPropertyValue("--divider").trim()||"rgba(0,0,0,0.06)";r=new d(c,{type:o==="jour"?"bar":"line",data:{labels:p,datasets:[{label:o==="jour"?"Calories":"Moy. calories",data:l,backgroundColor:l.map(m=>m>e?"rgba(244, 67, 54, 0.6)":"rgba(233, 30, 140, 0.5)"),borderColor:l.map(m=>m>e?g:i),borderWidth:2,borderRadius:o==="jour"?8:0,tension:.4,fill:o!=="jour",pointBackgroundColor:i,pointRadius:o!=="jour"?4:0}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1},tooltip:{backgroundColor:"rgba(0,0,0,0.8)",titleColor:"#fff",bodyColor:"#fff",cornerRadius:8,padding:12,callbacks:{label:m=>`${m.raw} kcal`}}},scales:{x:{grid:{display:!1},ticks:{color:a,font:{size:11}}},y:{grid:{color:f},ticks:{color:a,font:{size:11}},beginAtZero:!0}},annotation:{annotations:{targetLine:{type:"line",yMin:e,yMax:e,borderColor:"rgba(255, 152, 0, 0.5)",borderWidth:2,borderDash:[5,5]}}}}})}function E(){const u=t.querySelector("#history-details");if(!u)return;const p=new Date;p.setHours(12,0,0,0);const l=o==="jour"||o==="semaine"?7:30;let d="";for(let c=0;c<l;c++){const s=new Date(p);s.setDate(s.getDate()-c);const a=s.toISOString().split("T")[0],i=O(a),g=i.reduce((w,x)=>w+(x.calories||0),0);if(i.length===0)continue;const f=g>e,m=c===0?"Aujourd'hui":c===1?"Hier":s.toLocaleDateString("fr-FR",{weekday:"long",day:"numeric",month:"long"});d+=`
        <div class="card-glass mb-sm history-day-card" data-day="${a}">
          <div class="flex-between" style="cursor:pointer;" data-toggle-day="${a}">
            ...
            <div style="text-align:right;">
              <span class="badge ${f?"badge-danger":"badge-success"}" style="font-size:var(--font-sm);">
                ${Math.round(g)} / ${e} kcal
              </span>
            </div>
          </div>
          <div class="history-day-items" id="day-items-${a}" style="display:none;margin-top:var(--space-sm);">
            ${i.map(w=>{const x=w.productId?N(w.productId):null;return`
                <div class="consumption-item" style="padding:var(--space-xs) 0;">
                  <div class="consumption-item-info">
                    <div class="consumption-item-name" style="font-size:var(--font-xs);">${(x==null?void 0:x.name)||w.productNameBackup||"Produit inconnu"}</div>
                    <div class="consumption-item-detail">${w.grams}g</div>
                  </div>
                  <div style="font-size:var(--font-sm);font-weight:var(--fw-semibold);">${Math.round(w.calories)} kcal</div>
                </div>
              `}).join("")}
          </div>
        </div>
      ...
      `),u.innerHTML=d,u.querySelectorAll("[data-toggle-day]").forEach(c=>{c.addEventListener("click",()=>{const s=c.dataset.toggleDay,a=u.querySelector(`#day-items-${s}`);a&&(a.style.display=a.style.display==="none"?"block":"none")})})}return v(),()=>{r&&(r.destroy(),r=null)}}function Ce(t){const n=W();Z();let e=!1,o=n?{...n}:{};function r(){const k=J();t.innerHTML=`
    ...
    `,y()}function v(){if(!n)return'<p class="text-secondary">Aucun profil configuré</p>';const k=n.sex==="homme"?"👨 Homme":"👩 Femme",b={sedentary:"Sédentaire",light:"Léger",moderate:"Modéré",active:"Actif","very-active":"Très actif"};return`
      <div class="profile-summary">
        ...
        <div class="flex-between">
          ...
          <strong>${b[n.activityLevel]||"Sédentaire"}</strong>
        </div>
      </div>
    ...
    `}function y(){var b,E,u,p,l;(b=t.querySelector("#btn-toggle-edit"))==null||b.addEventListener("click",()=>{e=!e,e&&n&&(o={...n}),r()}),t.querySelectorAll("[data-edit-sex]").forEach(d=>{d.addEventListener("click",()=>{o.sex=d.dataset.editSex,r()})}),t.querySelectorAll("[data-edit-activity]").forEach(d=>{d.addEventListener("click",()=>{o.activityLevel=d.dataset.editActivity,r()})});const k={"edit-age":"age","edit-height":"height","edit-weight":"weight","edit-goal":"goalWeight","edit-duration":"duration"};for(const[d,c]of Object.entries(k))(E=t.querySelector(`#${d}`))==null||E.addEventListener("input",s=>{o[c]=s.target.value});(u=t.querySelector("#btn-save-profile"))==null||u.addEventListener("click",()=>{const d={...o,age:parseInt(o.age),weight:parseFloat(o.weight),height:parseInt(o.height)||170,goalWeight:parseFloat(o.goalWeight),duration:parseInt(o.duration)},c=Q(d);le({...d,bmr:c.bmr,tdee:c.tdee,dailyDeficit:c.dailyDeficit,dailyTarget:c.dailyTarget}),e=!1,L("Profil mis à jour ! Objectif recalculé.","success"),r()}),(p=t.querySelector("#btn-toggle-theme"))==null||p.addEventListener("click",()=>{const c=J()==="light"?"dark":"light";ye(c),r()}),(l=t.querySelector("#btn-clear-data"))==null||l.addEventListener("click",()=>{confirm("Êtes-vous sûr(e) de vouloir supprimer toutes les données ? Cette action est irréversible.")&&(we(),L("Toutes les données ont été supprimées","info"),window.location.hash="",window.location.reload())})}return r(),()=>{}}const K=document.getElementById("app");let ue=null,j=null;const je=[{id:"dashboard",icon:"🏠",label:"Accueil"},{id:"products",icon:"🍎",label:"Produits"},{id:"history",icon:"📊",label:"Historique"},{id:"settings",icon:"⚙️",label:"Réglages"}];function Te(){const t=J();document.documentElement.setAttribute("data-theme",t),window.addEventListener("hashchange",ie),ce()?ie():Y("onboarding"),X("profile:updated",()=>{ue==="onboarding"&&R("dashboard")})}function ie(){if(!ce()){Y("onboarding");return}const t=window.location.hash.slice(1)||"dashboard",[n,...e]=t.split("/");Y(n,e)}function R(t,n=[]){const e=n.length?`${t}/${n.join("/")}`:t;window.location.hash=e}function Y(t,n=[]){j&&(j(),j=null),ue=t;const e=document.createElement("div");switch(e.className="view-container view-enter",e.id="view-container",K.innerHTML="",K.appendChild(e),t){case"onboarding":j=Ee(e);break;case"dashboard":j=se(e),H("dashboard");break;case"products":j=qe(e,n),H("products");break;case"history":j=Me(e),H("history");break;case"settings":j=Ce(e),H("settings");break;default:j=se(e),H("dashboard")}}function H(t){const n=document.querySelector(".nav-bar");n&&n.remove();const e=document.createElement("nav");e.className="nav-bar",e.innerHTML=je.map(o=>`
