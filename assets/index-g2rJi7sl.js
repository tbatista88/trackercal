(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const g of r)if(g.type==="childList")for(const k of g.addedNodes)k.tagName==="LINK"&&k.rel==="modulepreload"&&i(k)}).observe(document,{childList:!0,subtree:!0});function a(r){const g={};return r.integrity&&(g.integrity=r.integrity),r.referrerPolicy&&(g.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?g.credentials="include":r.crossOrigin==="anonymous"?g.credentials="omit":g.credentials="same-origin",g}function i(r){if(r.ep)return;r.ep=!0;const g=a(r);fetch(r.href,g)}})();const D={PROFILE:"tcv2_profile",PRODUCTS:"tcv2_products",CONSUMPTIONS:"tcv2_consumptions",SETTINGS:"tcv2_settings",BACKUP_REMINDER:"tcv2_backup_reminder"};function le(){return Date.now().toString(36)+Math.random().toString(36).substr(2,9)}function O(e,n=null){try{const a=localStorage.getItem(e);return a?JSON.parse(a):n}catch{return n}}function M(e,n){localStorage.setItem(e,JSON.stringify(n))}function me(){return new Date().toISOString().split("T")[0]}const N={};function X(e,n){return N[e]||(N[e]=[]),N[e].push(n),()=>{N[e]=N[e].filter(a=>a!==n)}}function P(e,n){N[e]&&N[e].forEach(a=>a(n))}function _(){return O(D.PROFILE,null)}function ce(e){const n={...e,updatedAt:new Date().toISOString()};return M(D.PROFILE,n),P("profile:updated",n),n}function de(){return _()!==null}function H(){return O(D.PRODUCTS,[])}function F(e){return H().find(n=>n.id===e)||null}function te(e){const n=H(),a={id:le(),name:e.name||"",description:e.description||"",caloriesPer100g:parseFloat(e.caloriesPer100g)||0,photo:e.photo||null,createdAt:new Date().toISOString()};return n.unshift(a),M(D.PRODUCTS,n),P("products:updated",n),a}function ve(e,n){const a=H(),i=a.findIndex(r=>r.id===e);return i===-1?null:(a[i]={...a[i],...n,updatedAt:new Date().toISOString()},M(D.PRODUCTS,a),P("products:updated",a),a[i])}function ge(e){const n=H().filter(a=>a.id!==e);M(D.PRODUCTS,n),P("products:updated",n)}function R(e=null){const n=O(D.CONSUMPTIONS,[]);return e?n.filter(a=>a.date===e):n}function be(e){const n=R(),a={id:le(),productId:e.productId||null,productNameBackup:e.productNameBackup||"",productPhotoBackup:e.productPhotoBackup||null,caloriesPer100gBackup:e.caloriesPer100gBackup||0,grams:parseFloat(e.grams)||0,calories:parseFloat(e.calories)||0,meal:e.meal||"collation",notes:e.notes||"",date:e.date||me(),createdAt:new Date().toISOString()};return n.unshift(a),M(D.CONSUMPTIONS,n),P("consumptions:updated",n),a}function fe(e){const n=R().filter(a=>a.id!==e);M(D.CONSUMPTIONS,n),P("consumptions:updated",n)}function he(e,n){return R().filter(i=>i.date>=e&&i.date<=n)}function Z(){return O(D.SETTINGS,{theme:"light",notifications:!1})}function ye(e){const n={...Z(),...e};return M(D.SETTINGS,n),P("settings:updated",n),n}function G(){return Z().theme||"light"}function Se(e){ye({theme:e}),document.documentElement.setAttribute("data-theme",e)}function we(e){const n=_(),a=R(e),i=a.reduce(($,f)=>$+f.calories,0),r=(n==null?void 0:n.dailyTarget)||0,g={"petit-dejeuner":[],dejeuner:[],diner:[],collation:[]};a.forEach($=>{const f=$.meal||"collation";g[f]?g[f].push($):g.collation.push($)});const k={"petit-dejeuner":"🌅 Petit-déjeuner",dejeuner:"☀️ Déjeuner",diner:"🌙 Dîner",collation:"🍪 Collation"};let S=`📊 Mon Suivi Calories – ${e}
`;S+=`━━━━━━━━━━━━━━━━━━━━
`,S+=`🎯 Objectif : ${Math.round(r)} kcal
`,S+=`📈 Consommé : ${Math.round(i)} kcal
`,S+=`${i<=r?"✅":"⚠️"} ${i<=r?"Objectif respecté !":"Objectif dépassé !"}

`;for(const[$,f]of Object.entries(g))f.length!==0&&(S+=`${k[$]}
`,f.forEach(L=>{S+=`  • ${L.productNameBackup} – ${L.grams}g – ${Math.round(L.calories)} kcal
`}),S+=`
`);return S}function xe(){return{version:"1.0",exportedAt:new Date().toISOString(),profile:O(D.PROFILE,null),products:O(D.PRODUCTS,[]),consumptions:O(D.CONSUMPTIONS,[]),settings:O(D.SETTINGS,{theme:"light",notifications:!1})}}function ke(e){if(!e||!e.version)throw new Error("Invalid backup file format");e.profile&&(M(D.PROFILE,e.profile),P("profile:updated",e.profile)),e.products&&Array.isArray(e.products)&&(M(D.PRODUCTS,e.products),P("products:updated",e.products)),e.consumptions&&Array.isArray(e.consumptions)&&(M(D.CONSUMPTIONS,e.consumptions),P("consumptions:updated",e.consumptions)),e.settings&&(M(D.SETTINGS,e.settings),P("settings:updated",e.settings),e.settings.theme&&document.documentElement.setAttribute("data-theme",e.settings.theme)),P("data:imported")}function $e(){Object.values(D).forEach(e=>localStorage.removeItem(e)),P("data:cleared")}const Ee=2;function ee(){return O(D.BACKUP_REMINDER,{lastReminderDate:null,lastBackupDate:null,hasShownFirstReminder:!1})}function Le(e){const n={...ee(),...e};return M(D.BACKUP_REMINDER,n),n}function De(){const e=ee(),n=new Date;if(n.toISOString().split("T")[0],!e.hasShownFirstReminder)return!!(_()||R().length>0||H().length>0);if(!e.lastReminderDate)return!0;const a=new Date(e.lastReminderDate);return Math.floor((n-a)/(1e3*60*60*24))>=Ee}function qe(){ee(),Le({lastReminderDate:new Date().toISOString().split("T")[0],hasShownFirstReminder:!0})}function Pe(e,n,a,i){const r=10*a+6.25*i-5*e;return n==="homme"?r+5:r-161}function Me(e,n="sedentary"){return e*({sedentary:1.2,light:1.375,moderate:1.55,active:1.725,"very-active":1.9}[n]||1.2)}function K(e){const{age:n,sex:a,weight:i,height:r,goalWeight:g,duration:k,activityLevel:S}=e,$=Pe(n,a,i,r||170),f=Me($,S||"sedentary"),L=i-g,c=k*30;let d=0;L>0&&c>0&&(d=L*7700/c);let l=f-d;return l<1200&&(l=1200),l>f+1e3&&(l=f+1e3),{bmr:Math.round($),tdee:Math.round(f),dailyDeficit:Math.round(d),dailyTarget:Math.round(l)}}function ae(e,n){return e*n/100}function ne(e){return e*.23900573614}let V=null;function Ce(){return V||(V=document.createElement("div"),V.className="toast-container",document.body.appendChild(V)),V}function E(e,n="info",a=3e3){const i={success:"✅",error:"❌",warning:"⚠️",info:"ℹ️"},r=document.createElement("div");r.className="toast",r.innerHTML=`
    <span class="toast-icon">${i[n]||i.info}</span>
    <span class="toast-message">${e}</span>
  `,Ce().appendChild(r),setTimeout(()=>{r.style.animation="fadeOut 0.3s ease forwards",setTimeout(()=>r.remove(),300)},a)}const J=[{id:"welcome",title:"Bienvenue ! 🌸",subtitle:"Configurons votre profil pour calculer votre objectif calorique quotidien."},{id:"basics",title:"Informations de base",subtitle:"Ces données nous aident à calculer votre métabolisme."},{id:"goals",title:"Votre objectif",subtitle:"Définissez votre poids cible et la durée souhaitée."},{id:"summary",title:"Votre plan",subtitle:"Voici votre objectif calorique calculé."}];function Te(e){let n=0,a={age:"",sex:"femme",weight:"",height:"170",goalWeight:"",duration:"3",activityLevel:"sedentary"};function i(){const l=J[n];e.innerHTML=`
    ...
    `,L()}function r(){switch(n){case 0:return g();case 1:return k();case 2:return S();case 3:return $();default:return""}}function g(){return`
    ...
    `}function k(){const l=[{value:"sedentary",label:"Sédentaire",desc:"Bureau, peu d'exercice"},{value:"light",label:"Léger",desc:"Exercice 1-3j/semaine"},{value:"moderate",label:"Modéré",desc:"Exercice 3-5j/semaine"},{value:"active",label:"Actif",desc:"Exercice 6-7j/semaine"}];return`
    ...
    `}function $(){const l=K({age:parseInt(a.age)||30,sex:a.sex,weight:parseFloat(a.weight)||70,height:parseInt(a.height)||170,goalWeight:parseFloat(a.goalWeight)||65,duration:parseInt(a.duration)||3,activityLevel:a.activityLevel}),v=(parseFloat(a.weight)||70)-(parseFloat(a.goalWeight)||65),u=v>0;return`
    ...
    `}function f(){const l={"onb-age":"age","onb-height":"height","onb-weight":"weight","onb-goal":"goalWeight","onb-duration":"duration"};for(const[v,u]of Object.entries(l)){const s=e.querySelector(`#${v}`);s&&(a[u]=s.value)}}function L(){e.querySelectorAll("[data-sex]").forEach(t=>{t.addEventListener("click",()=>{f(),a.sex=t.dataset.sex,i()})}),e.querySelectorAll("[data-activity]").forEach(t=>{t.addEventListener("click",()=>{f(),a.activityLevel=t.dataset.activity,i()})});const l={"onb-age":"age","onb-height":"height","onb-weight":"weight","onb-goal":"goalWeight","onb-duration":"duration"};for(const[t,o]of Object.entries(l)){const m=e.querySelector(`#${t}`);m&&m.addEventListener("input",()=>{a[o]=m.value})}const v=e.querySelector("#btn-next"),u=e.querySelector("#btn-prev"),s=e.querySelector("#btn-finish");v&&v.addEventListener("click",()=>{f(),c()&&(n++,i())}),u&&u.addEventListener("click",()=>{f(),n--,i()}),s&&s.addEventListener("click",()=>{f(),d()})}function c(){switch(n){case 1:return!a.age||parseInt(a.age)<15?(E("Veuillez entrer un âge valide (15+)","warning"),!1):!a.weight||parseFloat(a.weight)<30?(E("Veuillez entrer un poids valide","warning"),!1):!0;case 2:return!a.goalWeight||parseFloat(a.goalWeight)<30?(E("Veuillez entrer un objectif de poids valide","warning"),!1):!a.duration||parseInt(a.duration)<1?(E("Veuillez entrer une durée valide (minimum 1 mois)","warning"),!1):!0;default:return!0}}function d(){const l=K({age:parseInt(a.age),sex:a.sex,weight:parseFloat(a.weight),height:parseInt(a.height)||170,goalWeight:parseFloat(a.goalWeight),duration:parseInt(a.duration),activityLevel:a.activityLevel});ce({...a,age:parseInt(a.age),weight:parseFloat(a.weight),height:parseInt(a.height)||170,goalWeight:parseFloat(a.goalWeight),duration:parseInt(a.duration),bmr:l.bmr,tdee:l.tdee,dailyDeficit:l.dailyDeficit,dailyTarget:l.dailyTarget}),E("Profil créé avec succès ! 🎉","success")}return i(),()=>{}}const se={"petit-dejeuner":{icon:"🌅",label:"Petit-déjeuner"},dejeuner:{icon:"☀️",label:"Déjeuner"},diner:{icon:"🌙",label:"Dîner"},collation:{icon:"🍪",label:"Collation"}};function oe(e){const n=_(),a=new Date().toISOString().split("T")[0];let i=a;const r=[];function g(){const c=R(i),d=c.reduce((w,y)=>w+(y.calories||0),0),l=(n==null?void 0:n.dailyTarget)||2e3,v=Math.min(d/l*100,100),u=d>l,s=l-d,t={};for(const w of Object.keys(se))t[w]=c.filter(y=>y.meal===w);const o=new Date(i+"T12:00:00"),m=i===a,b=m?"Aujourd'hui":o.toLocaleDateString("fr-FR",{weekday:"long",day:"numeric",month:"long"}),p=2*Math.PI*54,h=p-v/100*p;e.innerHTML=`
      <div class="dashboard">
        ...
        <div class="dashboard-meals" style="padding:0 var(--space-md);">
          ${Object.entries(se).map(([w,y])=>{const x=t[w]||[],C=x.reduce((q,z)=>q+(z.calories||0),0);return`
    ...
    `,S()}function k(c){const d=c.productId?F(c.productId):null,l=(d==null?void 0:d.photo)||c.productPhotoBackup,v=(d==null?void 0:d.name)||c.productNameBackup||"Produit inconnu";return`
    ...
    `}function S(){var c,d,l,v,u;(c=e.querySelector("#btn-date-prev"))==null||c.addEventListener("click",()=>{const s=new Date(i+"T12:00:00");s.setDate(s.getDate()-1),i=s.toISOString().split("T")[0],g()}),(d=e.querySelector("#btn-date-next"))==null||d.addEventListener("click",()=>{const s=new Date(i+"T12:00:00");s.setDate(s.getDate()+1);const t=s.toISOString().split("T")[0];t<=a&&(i=t,g())}),(l=e.querySelector("#btn-date-today"))==null||l.addEventListener("click",()=>{i=a,g()}),(v=e.querySelector("#btn-add-food"))==null||v.addEventListener("click",()=>{B("products",["select"])}),e.querySelectorAll("[data-add-meal]").forEach(s=>{s.addEventListener("click",()=>{const t=s.dataset.addMeal;B("products",["select",t])})}),(u=e.querySelector("#btn-export"))==null||u.addEventListener("click",()=>{const s=we(i);if(navigator.clipboard)navigator.clipboard.writeText(s).then(()=>{E("Résumé copié dans le presse-papiers ! 📋","success")});else{const t=document.createElement("textarea");t.value=s,document.body.appendChild(t),t.select(),document.execCommand("copy"),document.body.removeChild(t),E("Résumé copié ! 📋","success")}}),e.querySelectorAll("[data-edit-consumption]").forEach(s=>{s.addEventListener("click",t=>{t.stopPropagation();const o=s.dataset.editConsumption;$(o)})}),e.querySelectorAll("[data-delete-consumption]").forEach(s=>{s.addEventListener("click",t=>{t.stopPropagation();const o=s.dataset.deleteConsumption;confirm("Supprimer ce repas ?")&&(fe(o),E("Repas supprimé","info"),g())})})}function $(c){const{getConsumption:d}=f(),l=d(c);if(!l)return;const v=l.productId?F(l.productId):null,u=l.productId&&!v,s=(v==null?void 0:v.name)||l.productNameBackup||"Produit inconnu",t=(v==null?void 0:v.caloriesPer100g)||l.caloriesPer100gBackup||0,o=document.createElement("div");o.className="modal-overlay",o.innerHTML=`
    ...
    `,document.body.appendChild(o);const m=o.querySelector("#edit-grams"),b=o.querySelector("#edit-cal-preview");m&&b&&!u&&m.addEventListener("input",()=>{const h=parseFloat(m.value)||0;b.textContent=Math.round(t*h/100)+" kcal"});const p=()=>o.remove();o.querySelector("#modal-close-edit").addEventListener("click",p),o.addEventListener("click",h=>{h.target===o&&p()}),o.querySelector("#btn-save-edit").addEventListener("click",()=>{parseFloat(m.value),o.querySelector("#edit-notes").value,u&&parseFloat(o.querySelector("#edit-calories").value),E("Consommation modifiée ✅","success"),p(),g()})}function f(){return{getConsumption:c=>R().find(d=>d.id===c),updateConsumption:(c,d)=>{},getProduct:F}}const L=X("consumptions:updated",()=>g());return r.push(L),g(),()=>{r.forEach(c=>c())}}const je="modulepreload",Ie=function(e){return"/trackercal/"+e},ie={},ue=function(n,a,i){let r=Promise.resolve();if(a&&a.length>0){let k=function(f){return Promise.all(f.map(L=>Promise.resolve(L).then(c=>({status:"fulfilled",value:c}),c=>({status:"rejected",reason:c}))))};document.getElementsByTagName("link");const S=document.querySelector("meta[property=csp-nonce]"),$=(S==null?void 0:S.nonce)||(S==null?void 0:S.getAttribute("nonce"));r=k(a.map(f=>{if(f=Ie(f),f in ie)return;ie[f]=!0;const L=f.endsWith(".css"),c=L?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${f}"]${c}`))return;const d=document.createElement("link");if(d.rel=L?"stylesheet":je,L||(d.as="script"),d.crossOrigin="",d.href=f,$&&d.setAttribute("nonce",$),document.head.appendChild(d),L)return new Promise((l,v)=>{d.addEventListener("load",l),d.addEventListener("error",()=>v(new Error(`Unable to preload CSS for ${f}`)))})}))}function g(k){const S=new Event("vite:preloadError",{cancelable:!0});if(S.payload=k,window.dispatchEvent(S),!S.defaultPrevented)throw k}return r.then(k=>{for(const S of k||[])S.status==="rejected"&&g(S.reason);return n().catch(g)})};async function Oe(e){try{const n=await fetch(`https://world.openfoodfacts.org/api/v2/product/${e}`,{headers:{"User-Agent":"MonSuiviCalories/1.0"}});if(!n.ok)return null;const a=await n.json();if(a.status!==1||!a.product)return null;const i=a.product;let r=0;const g=i.nutriments||{};return g["energy-kcal_100g"]?r=parseFloat(g["energy-kcal_100g"]):g["energy-kcal"]?r=parseFloat(g["energy-kcal"]):g.energy_100g?r=Math.round(ne(parseFloat(g.energy_100g))):g.energy&&(r=Math.round(ne(parseFloat(g.energy)))),{name:i.product_name||i.product_name_fr||"Produit inconnu",image:i.image_front_url||i.image_front_small_url||null,caloriesPer100g:Math.round(r),brand:i.brands||"",barcode:e}}catch(n){return console.error("Erreur API Open Food Facts:",n),null}}function ze(e,n=[]){const a=n[0]==="select",i=n[1]||null;let r="";const g=[];function k(){const s=H(),t=r?s.filter(o=>o.name.toLowerCase().includes(r.toLowerCase())):s;e.innerHTML=`
    ...
    `,document.body.appendChild(o);let m=(t==null?void 0:t.photo)||null;const b=o.querySelector("#photo-input"),p=o.querySelector("#photo-upload-area");b.addEventListener("change",w=>{const y=w.target.files[0];if(!y)return;const x=new FileReader;x.onload=C=>{const q=new Image;q.onload=()=>{const z=document.createElement("canvas"),A=400;let T=q.width,j=q.height;T>j?T>A&&(j*=A/T,T=A):j>A&&(T*=A/j,j=A),z.width=T,z.height=j,z.getContext("2d").drawImage(q,0,0,T,j),m=z.toDataURL("image/jpeg",.7);let U=p.querySelector("img");U||(U=document.createElement("img"),p.appendChild(U)),U.src=m,U.alt="Photo",p.querySelector(".photo-upload-icon").style.display="none",p.querySelector(".photo-upload-text").style.display="none"},q.src=C.target.result},x.readAsDataURL(y)});const h=()=>o.remove();o.querySelector("#modal-close-product").addEventListener("click",h),o.addEventListener("click",w=>{w.target===o&&h()}),o.querySelector("#btn-save-product").addEventListener("click",()=>{const w=o.querySelector("#prod-name").value.trim(),y=o.querySelector("#prod-desc").value.trim(),x=parseFloat(o.querySelector("#prod-cal").value);if(!w){E("Veuillez entrer un nom","warning");return}if(isNaN(x)||x<0){E("Veuillez entrer des calories valides","warning");return}t?(ve(s,{name:w,description:y,caloriesPer100g:x,photo:m}),E("Produit modifié ✅","success")):(te({name:w,description:y,caloriesPer100g:x,photo:m}),E("Produit ajouté au catalogue ! 🎉","success")),h(),k()})}function L(s){const t=F(s);if(!t)return;const o=document.createElement("div");o.className="modal-overlay",o.innerHTML=`
      <div class="modal-content">
        <div class="modal-handle"></div>
    ...
    `,document.body.appendChild(s);const t=()=>s.remove();s.querySelector("#modal-close-manual").addEventListener("click",t),s.addEventListener("click",o=>{o.target===s&&t()}),s.querySelector("#btn-search-barcode").addEventListener("click",async()=>{const o=s.querySelector("#manual-barcode").value.trim();if(!o){E("Veuillez entrer un code-barres","warning");return}t(),await l(o)})}async function l(s){E("Recherche en cours...","info",2e3);const t=await Oe(s);if(!t){E("Produit non trouvé dans la base Open Food Facts","error");return}v(t)}function v(s){const t=document.createElement("div");t.className="modal-overlay",t.innerHTML=`
      <div class="modal-content">
        <div class="modal-handle"></div>
    ...
    `,document.body.appendChild(t);const o=()=>t.remove();t.querySelector("#modal-close-result").addEventListener("click",o),t.addEventListener("click",m=>{m.target===t&&o()}),t.querySelector("#btn-add-barcode-product").addEventListener("click",()=>{te({name:s.name,description:s.brand||"",caloriesPer100g:s.caloriesPer100g,photo:s.image||null}),E("Produit ajouté au catalogue ! 🎉","success"),o(),k()})}const u=X("products:updated",()=>k());return g.push(u),k(),()=>{g.forEach(s=>s())}}function Ae(e){const n=_(),a=(n==null?void 0:n.dailyTarget)||2e3;let i="jour",r=null;function g(){e.innerHTML=`
    ...
    `,k(),f(),L()}function k(){e.querySelectorAll("[data-filter]").forEach(c=>{c.addEventListener("click",()=>{i=c.dataset.filter,g()})})}function S(){const c=new Date;c.setHours(12,0,0,0);let d,l;switch(i){case"jour":{d=new Date(c),d.setDate(d.getDate()-6),l=new Date(c);break}case"semaine":{d=new Date(c),d.setDate(d.getDate()-27),l=new Date(c);break}case"mois":{d=new Date(c),d.setMonth(d.getMonth()-5),d.setDate(1),l=new Date(c);break}}return{start:d.toISOString().split("T")[0],end:l.toISOString().split("T")[0]}}function $(){const{start:c,end:d}=S(),l=he(c,d),v={};if(l.forEach(u=>{v[u.date]||(v[u.date]=0),v[u.date]+=u.calories||0}),i==="jour"){const u=[],s=[],t=new Date;t.setHours(12,0,0,0);for(let o=6;o>=0;o--){const m=new Date(t);m.setDate(m.getDate()-o);const b=m.toISOString().split("T")[0],p=m.toLocaleDateString("fr-FR",{weekday:"short",day:"numeric"});u.push(p),s.push(Math.round(v[b]||0))}return{labels:u,values:s}}if(i==="semaine"){const u=[],s=[],t=new Date;t.setHours(12,0,0,0);for(let o=3;o>=0;o--){const m=new Date(t);m.setDate(m.getDate()-o*7);const b=new Date(m);b.setDate(b.getDate()-6);let p=0,h=0;for(let x=0;x<=6;x++){const C=new Date(b);C.setDate(C.getDate()+x);const q=C.toISOString().split("T")[0];v[q]&&(p+=v[q],h++)}const w=h>0?Math.round(p/h):0,y=b.toLocaleDateString("fr-FR",{day:"numeric",month:"short"});u.push(`Sem. ${y}`),s.push(w)}return{labels:u,values:s}}if(i==="mois"){const u=[],s=[],t=new Date;for(let o=5;o>=0;o--){const m=new Date(t.getFullYear(),t.getMonth()-o,1),b=new Date(t.getFullYear(),t.getMonth()-o+1,0);let p=0,h=0;for(let y=1;y<=b.getDate();y++){const x=`${m.getFullYear()}-${String(m.getMonth()+1).padStart(2,"0")}-${String(y).padStart(2,"0")}`;v[x]&&(p+=v[x],h++)}const w=h>0?Math.round(p/h):0;u.push(m.toLocaleDateString("fr-FR",{month:"short"})),s.push(w)}return{labels:u,values:s}}return{labels:[],values:[]}}async function f(){const c=e.querySelector("#calorie-chart");if(!c)return;const{labels:d,values:l}=$();let v;try{const p=await ue(()=>import("./chart-45xamTTr.js"),[]);v=p.Chart;const{CategoryScale:h,LinearScale:w,BarElement:y,LineElement:x,PointElement:C,Title:q,Tooltip:z,Legend:A,BarController:T,LineController:j}=p;v.register(h,w,y,x,C,q,z,A,T,j)}catch(p){console.error("Chart.js not available:",p),c.parentElement.innerHTML='<p style="text-align:center;color:var(--text-tertiary);padding:var(--space-lg);">Graphique non disponible</p>';return}r&&r.destroy();const u=c.getContext("2d");l.map(p=>p>a);const s=getComputedStyle(document.documentElement),t=s.getPropertyValue("--text-secondary").trim()||"#6B4D5A",o=s.getPropertyValue("--accent").trim()||"#E91E8C",m="#F44336",b=s.getPropertyValue("--divider").trim()||"rgba(0,0,0,0.06)";r=new v(u,{type:i==="jour"?"bar":"line",data:{labels:d,datasets:[{label:i==="jour"?"Calories":"Moy. calories",data:l,backgroundColor:l.map(p=>p>a?"rgba(244, 67, 54, 0.6)":"rgba(233, 30, 140, 0.5)"),borderColor:l.map(p=>p>a?m:o),borderWidth:2,borderRadius:i==="jour"?8:0,tension:.4,fill:i!=="jour",pointBackgroundColor:o,pointRadius:i!=="jour"?4:0}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1},tooltip:{backgroundColor:"rgba(0,0,0,0.8)",titleColor:"#fff",bodyColor:"#fff",cornerRadius:8,padding:12,callbacks:{label:p=>`${p.raw} kcal`}}},scales:{x:{grid:{display:!1},ticks:{color:t,font:{size:11}}},y:{grid:{color:b},ticks:{color:t,font:{size:11}},beginAtZero:!0}},annotation:{annotations:{targetLine:{type:"line",yMin:a,yMax:a,borderColor:"rgba(255, 152, 0, 0.5)",borderWidth:2,borderDash:[5,5]}}}}})}function L(){const c=e.querySelector("#history-details");if(!c)return;const d=new Date;d.setHours(12,0,0,0);const l=i==="jour"||i==="semaine"?7:30;let v="";for(let u=0;u<l;u++){const s=new Date(d);s.setDate(s.getDate()-u);const t=s.toISOString().split("T")[0],o=R(t),m=o.reduce((h,w)=>h+(w.calories||0),0);if(o.length===0)continue;const b=m>a,p=u===0?"Aujourd'hui":u===1?"Hier":s.toLocaleDateString("fr-FR",{weekday:"long",day:"numeric",month:"long"});v+=`
        <div class="card-glass mb-sm history-day-card" data-day="${t}">
          ...
          <div class="history-day-items" id="day-items-${t}" style="display:none;margin-top:var(--space-sm);">
            ${o.map(h=>{const w=h.productId?F(h.productId):null;return`
      ...
      `),c.innerHTML=v,c.querySelectorAll("[data-toggle-day]").forEach(u=>{u.addEventListener("click",()=>{const s=u.dataset.toggleDay,t=c.querySelector(`#day-items-${s}`);t&&(t.style.display=t.style.display==="none"?"block":"none")})})}return g(),()=>{r&&(r.destroy(),r=null)}}function Re(e){const n=_();Z();let a=!1,i=n?{...n}:{};function r(){const $=G();e.innerHTML=`
        ...
        <div style="padding:0 var(--space-md);">
          ...
          <div class="card-glass mb-md">
            ...
            <div class="toggle-container">
              ...
              <button class="toggle-switch ${$==="dark"?"active":""}" id="btn-toggle-theme" aria-label="Mode sombre"></button>
            </div>
          </div>
    ...
    `,S()}function g(){if(!n)return'<p class="text-secondary">Aucun profil configuré</p>';const $=n.sex==="homme"?"👨 Homme":"👩 Femme",f={sedentary:"Sédentaire",light:"Léger",moderate:"Modéré",active:"Actif","very-active":"Très actif"};return`
    ...
    `}function k(){const $=[{value:"sedentary",label:"Sédentaire"},{value:"light",label:"Léger"},{value:"moderate",label:"Modéré"},{value:"active",label:"Actif"}];return`
      <div class="edit-form">
    ...
    `}function S(){var f,L,c,d,l,v,u,s;(f=e.querySelector("#btn-toggle-edit"))==null||f.addEventListener("click",()=>{a=!a,a&&n&&(i={...n}),r()}),e.querySelectorAll("[data-edit-sex]").forEach(t=>{t.addEventListener("click",()=>{i.sex=t.dataset.editSex,r()})}),e.querySelectorAll("[data-edit-activity]").forEach(t=>{t.addEventListener("click",()=>{i.activityLevel=t.dataset.editActivity,r()})});const $={"edit-age":"age","edit-height":"height","edit-weight":"weight","edit-goal":"goalWeight","edit-duration":"duration"};for(const[t,o]of Object.entries($))(L=e.querySelector(`#${t}`))==null||L.addEventListener("input",m=>{i[o]=m.target.value});(c=e.querySelector("#btn-save-profile"))==null||c.addEventListener("click",()=>{const t={...i,age:parseInt(i.age),weight:parseFloat(i.weight),height:parseInt(i.height)||170,goalWeight:parseFloat(i.goalWeight),duration:parseInt(i.duration)},o=K(t);ce({...t,bmr:o.bmr,tdee:o.tdee,dailyDeficit:o.dailyDeficit,dailyTarget:o.dailyTarget}),a=!1,E("Profil mis à jour ! Objectif recalculé.","success"),r()}),(d=e.querySelector("#btn-toggle-theme"))==null||d.addEventListener("click",()=>{const o=G()==="light"?"dark":"light";Se(o),r()}),(l=e.querySelector("#btn-clear-data"))==null||l.addEventListener("click",()=>{confirm("Êtes-vous sûr(e) de vouloir supprimer toutes les données ? Cette action est irréversible.")&&($e(),E("Toutes les données ont été supprimées","info"),window.location.hash="",window.location.reload())}),(v=e.querySelector("#btn-export-data"))==null||v.addEventListener("click",()=>{try{const t=xe(),o=new Blob([JSON.stringify(t,null,2)],{type:"application/json"}),m=URL.createObjectURL(o),b=document.createElement("a"),p=new Date().toISOString().split("T")[0];b.href=m,b.download=`trackercal-backup-${p}.json`,document.body.appendChild(b),b.click(),document.body.removeChild(b),URL.revokeObjectURL(m),E("Sauvegarde créée avec succès !","success")}catch{E("Erreur lors de l'exportation","error")}}),(u=e.querySelector("#btn-import-data"))==null||u.addEventListener("click",()=>{var t;(t=e.querySelector("#file-import"))==null||t.click()}),(s=e.querySelector("#file-import"))==null||s.addEventListener("change",async t=>{var m;const o=(m=t.target.files)==null?void 0:m[0];if(o){try{const b=await o.text(),p=JSON.parse(b);if(!p.version)throw new Error("Format invalide");confirm("Cette action remplacera toutes vos données actuelles. Voulez-vous continuer ?")&&(ke(p),E("Données importées avec succès !","success"),setTimeout(()=>window.location.reload(),1500))}catch{E("Erreur : fichier invalide","error")}t.target.value=""}})}return r(),()=>{}}const Q=document.getElementById("app");let pe=null,I=null;const Ne=[{id:"dashboard",icon:"🏠",label:"Accueil"},{id:"products",icon:"🍎",label:"Produits"},{id:"history",icon:"📊",label:"Historique"},{id:"settings",icon:"⚙️",label:"Réglages"}];function Fe(){if(!De())return;qe();const e=document.querySelector(".backup-reminder");e&&e.remove();const n=document.createElement("div");n.className="backup-reminder",n.innerHTML=`
    ...
    `,n.querySelector(".backup-reminder-btn").addEventListener("click",()=>{n.remove()}),document.body.appendChild(n),setTimeout(()=>{n.classList.add("show")},100)}function Be(){const e=G();document.documentElement.setAttribute("data-theme",e),Fe(),window.addEventListener("hashchange",re),de()?re():Y("onboarding"),X("profile:updated",()=>{pe==="onboarding"&&B("dashboard")})}function re(){if(!de()){Y("onboarding");return}const e=window.location.hash.slice(1)||"dashboard",[n,...a]=e.split("/");Y(n,a)}function B(e,n=[]){const a=n.length?`${e}/${n.join("/")}`:e;window.location.hash=a}function Y(e,n=[]){I&&(I(),I=null),pe=e;const a=document.createElement("div");switch(a.className="view-container view-enter",a.id="view-container",Q.innerHTML="",Q.appendChild(a),e){case"onboarding":I=Te(a);break;case"dashboard":I=oe(a),W("dashboard");break;case"products":I=ze(a,n),W("products");break;case"history":I=Ae(a),W("history");break;case"settings":I=Re(a),W("settings");break;default:I=oe(a),W("dashboard")}}function W(e){const n=document.querySelector(".nav-bar");n&&n.remove();const a=document.createElement("nav");a.className="nav-bar",a.innerHTML=Ne.map(i=>`
    <button class="nav-item ${i.id===e?"active":""}" data-view="${i.id}" aria-label="${i.label}">
      <span class="nav-item-icon">${i.icon}</span>
      <span>${i.label}</span>
    </button>
  `).join(""),a.addEventListener("click",i=>{const r=i.target.closest(".nav-item");if(!r)return;const g=r.dataset.view;B(g)}),Q.appendChild(a)}Be();
