(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const g of r)if(g.type==="childList")for(const $ of g.addedNodes)$.tagName==="LINK"&&$.rel==="modulepreload"&&i($)}).observe(document,{childList:!0,subtree:!0});function a(r){const g={};return r.integrity&&(g.integrity=r.integrity),r.referrerPolicy&&(g.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?g.credentials="include":r.crossOrigin==="anonymous"?g.credentials="omit":g.credentials="same-origin",g}function i(r){if(r.ep)return;r.ep=!0;const g=a(r);fetch(r.href,g)}})();const D={PROFILE:"tcv2_profile",PRODUCTS:"tcv2_products",CONSUMPTIONS:"tcv2_consumptions",SETTINGS:"tcv2_settings"};function re(){return Date.now().toString(36)+Math.random().toString(36).substr(2,9)}function A(e,s=null){try{const a=localStorage.getItem(e);return a?JSON.parse(a):s}catch{return s}}function C(e,s){localStorage.setItem(e,JSON.stringify(s))}function pe(){return new Date().toISOString().split("T")[0]}const F={};function X(e,s){return F[e]||(F[e]=[]),F[e].push(s),()=>{F[e]=F[e].filter(a=>a!==s)}}function q(e,s){F[e]&&F[e].forEach(a=>a(s))}function U(){return A(D.PROFILE,null)}function le(e){const s={...e,updatedAt:new Date().toISOString()};return C(D.PROFILE,s),q("profile:updated",s),s}function ce(){return U()!==null}function V(){return A(D.PRODUCTS,[])}function R(e){return V().find(s=>s.id===e)||null}function ee(e){const s=V(),a={id:re(),name:e.name||"",description:e.description||"",caloriesPer100g:parseFloat(e.caloriesPer100g)||0,photo:e.photo||null,createdAt:new Date().toISOString()};return s.unshift(a),C(D.PRODUCTS,s),q("products:updated",s),a}function me(e,s){const a=V(),i=a.findIndex(r=>r.id===e);return i===-1?null:(a[i]={...a[i],...s,updatedAt:new Date().toISOString()},C(D.PRODUCTS,a),q("products:updated",a),a[i])}function ve(e){const s=V().filter(a=>a.id!==e);C(D.PRODUCTS,s),q("products:updated",s)}function N(e=null){const s=A(D.CONSUMPTIONS,[]);return e?s.filter(a=>a.date===e):s}function ge(e){const s=N(),a={id:re(),productId:e.productId||null,productNameBackup:e.productNameBackup||"",productPhotoBackup:e.productPhotoBackup||null,caloriesPer100gBackup:e.caloriesPer100gBackup||0,grams:parseFloat(e.grams)||0,calories:parseFloat(e.calories)||0,meal:e.meal||"collation",notes:e.notes||"",date:e.date||pe(),createdAt:new Date().toISOString()};return s.unshift(a),C(D.CONSUMPTIONS,s),q("consumptions:updated",s),a}function be(e){const s=N().filter(a=>a.id!==e);C(D.CONSUMPTIONS,s),q("consumptions:updated",s)}function fe(e,s){return N().filter(i=>i.date>=e&&i.date<=s)}function Z(){return A(D.SETTINGS,{theme:"light",notifications:!1})}function he(e){const s={...Z(),...e};return C(D.SETTINGS,s),q("settings:updated",s),s}function J(){return Z().theme||"light"}function ye(e){he({theme:e}),document.documentElement.setAttribute("data-theme",e)}function Se(e){const s=U(),a=N(e),i=a.reduce((E,f)=>E+f.calories,0),r=(s==null?void 0:s.dailyTarget)||0,g={"petit-dejeuner":[],dejeuner:[],diner:[],collation:[]};a.forEach(E=>{const f=E.meal||"collation";g[f]?g[f].push(E):g.collation.push(E)});const $={"petit-dejeuner":"🌅 Petit-déjeuner",dejeuner:"☀️ Déjeuner",diner:"🌙 Dîner",collation:"🍪 Collation"};let S=`📊 Mon Suivi Calories – ${e}
`;S+=`━━━━━━━━━━━━━━━━━━━━
...
`}),S+=`
`);return S}function xe(){return{version:"1.0",exportedAt:new Date().toISOString(),profile:A(D.PROFILE,null),products:A(D.PRODUCTS,[]),consumptions:A(D.CONSUMPTIONS,[]),settings:A(D.SETTINGS,{theme:"light",notifications:!1})}}function we(e){if(!e||!e.version)throw new Error("Invalid backup file format");e.profile&&(C(D.PROFILE,e.profile),q("profile:updated",e.profile)),e.products&&Array.isArray(e.products)&&(C(D.PRODUCTS,e.products),q("products:updated",e.products)),e.consumptions&&Array.isArray(e.consumptions)&&(C(D.CONSUMPTIONS,e.consumptions),q("consumptions:updated",e.consumptions)),e.settings&&(C(D.SETTINGS,e.settings),q("settings:updated",e.settings),e.settings.theme&&document.documentElement.setAttribute("data-theme",e.settings.theme)),q("data:imported")}function $e(){Object.values(D).forEach(e=>localStorage.removeItem(e)),q("data:cleared")}function Ee(e,s,a,i){const r=10*a+6.25*i-5*e;return s==="homme"?r+5:r-161}function ke(e,s="sedentary"){return e*({sedentary:1.2,light:1.375,moderate:1.55,active:1.725,"very-active":1.9}[s]||1.2)}function Q(e){const{age:s,sex:a,weight:i,height:r,goalWeight:g,duration:$,activityLevel:S}=e,E=Ee(s,a,i,r||170),f=ke(E,S||"sedentary"),L=i-g,c=$*30;let d=0;L>0&&c>0&&(d=L*7700/c);let l=f-d;return l<1200&&(l=1200),l>f+1e3&&(l=f+1e3),{bmr:Math.round(E),tdee:Math.round(f),dailyDeficit:Math.round(d),dailyTarget:Math.round(l)}}function te(e,s){return e*s/100}function ae(e){return e*.23900573614}let H=null;function Le(){return H||(H=document.createElement("div"),H.className="toast-container",document.body.appendChild(H)),H}function k(e,s="info",a=3e3){const i={success:"✅",error:"❌",warning:"⚠️",info:"ℹ️"},r=document.createElement("div");r.className="toast",r.innerHTML=`
    <span class="toast-icon">${i[s]||i.info}</span>
    <span class="toast-message">${e}</span>
  `,Le().appendChild(r),setTimeout(()=>{r.style.animation="fadeOut 0.3s ease forwards",setTimeout(()=>r.remove(),300)},a)}const G=[{id:"welcome",title:"Bienvenue ! 🌸",subtitle:"Configurons votre profil pour calculer votre objectif calorique quotidien."},{id:"basics",title:"Informations de base",subtitle:"Ces données nous aident à calculer votre métabolisme."},{id:"goals",title:"Votre objectif",subtitle:"Définissez votre poids cible et la durée souhaitée."},{id:"summary",title:"Votre plan",subtitle:"Voici votre objectif calorique calculé."}];function De(e){let s=0,a={age:"",sex:"femme",weight:"",height:"170",goalWeight:"",duration:"3",activityLevel:"sedentary"};function i(){const l=G[s];e.innerHTML=`
      <div class="onboarding">
        <div class="onboarding-header">
          <div class="onboarding-progress">
            ${G.map((v,u)=>`
              <div class="onboarding-dot ${u<=s?"active":""}"></div>
            `).join("")}
          </div>
    ...
    `,L()}function r(){switch(s){case 0:return g();case 1:return $();case 2:return S();case 3:return E();default:return""}}function g(){return`
    ...
    `}function f(){const l={"onb-age":"age","onb-height":"height","onb-weight":"weight","onb-goal":"goalWeight","onb-duration":"duration"};for(const[v,u]of Object.entries(l)){const n=e.querySelector(`#${v}`);n&&(a[u]=n.value)}}function L(){e.querySelectorAll("[data-sex]").forEach(t=>{t.addEventListener("click",()=>{f(),a.sex=t.dataset.sex,i()})}),e.querySelectorAll("[data-activity]").forEach(t=>{t.addEventListener("click",()=>{f(),a.activityLevel=t.dataset.activity,i()})});const l={"onb-age":"age","onb-height":"height","onb-weight":"weight","onb-goal":"goalWeight","onb-duration":"duration"};for(const[t,o]of Object.entries(l)){const m=e.querySelector(`#${t}`);m&&m.addEventListener("input",()=>{a[o]=m.value})}const v=e.querySelector("#btn-next"),u=e.querySelector("#btn-prev"),n=e.querySelector("#btn-finish");v&&v.addEventListener("click",()=>{f(),c()&&(s++,i())}),u&&u.addEventListener("click",()=>{f(),s--,i()}),n&&n.addEventListener("click",()=>{f(),d()})}function c(){switch(s){case 1:return!a.age||parseInt(a.age)<15?(k("Veuillez entrer un âge valide (15+)","warning"),!1):!a.weight||parseFloat(a.weight)<30?(k("Veuillez entrer un poids valide","warning"),!1):!0;case 2:return!a.goalWeight||parseFloat(a.goalWeight)<30?(k("Veuillez entrer un objectif de poids valide","warning"),!1):!a.duration||parseInt(a.duration)<1?(k("Veuillez entrer une durée valide (minimum 1 mois)","warning"),!1):!0;default:return!0}}function d(){const l=Q({age:parseInt(a.age),sex:a.sex,weight:parseFloat(a.weight),height:parseInt(a.height)||170,goalWeight:parseFloat(a.goalWeight),duration:parseInt(a.duration),activityLevel:a.activityLevel});le({...a,age:parseInt(a.age),weight:parseFloat(a.weight),height:parseInt(a.height)||170,goalWeight:parseFloat(a.goalWeight),duration:parseInt(a.duration),bmr:l.bmr,tdee:l.tdee,dailyDeficit:l.dailyDeficit,dailyTarget:l.dailyTarget}),k("Profil créé avec succès ! 🎉","success")}return i(),()=>{}}const se={"petit-dejeuner":{icon:"🌅",label:"Petit-déjeuner"},dejeuner:{icon:"☀️",label:"Déjeuner"},diner:{icon:"🌙",label:"Dîner"},collation:{icon:"🍪",label:"Collation"}};function ne(e){const s=U(),a=new Date().toISOString().split("T")[0];let i=a;const r=[];function g(){const c=N(i),d=c.reduce((x,y)=>x+(y.calories||0),0),l=(s==null?void 0:s.dailyTarget)||2e3,v=Math.min(d/l*100,100),u=d>l,n=l-d,t={};for(const x of Object.keys(se))t[x]=c.filter(y=>y.meal===x);const o=new Date(i+"T12:00:00"),m=i===a,b=m?"Aujourd'hui":o.toLocaleDateString("fr-FR",{weekday:"long",day:"numeric",month:"long"}),p=2*Math.PI*54,h=p-v/100*p;e.innerHTML=`
      <div class="dashboard">
        ...
        <div class="dashboard-ring-section ${u?"over-target-glow":""}" style="text-align:center;padding:var(--space-md);">
          ...
          <div class="flex-center gap-lg" style="margin-top:var(--space-md);">
            <div style="text-align:center;">
              <div style="font-size:var(--font-2xl);font-weight:var(--fw-bold);color:${u?"var(--danger)":n>0?"var(--success)":"var(--text-primary)"};">
                ${u?"+":""}${Math.abs(Math.round(n))}
              </div>
        ...
        <div class="dashboard-meals" style="padding:0 var(--space-md);">
          ${Object.entries(se).map(([x,y])=>{const w=t[x]||[],M=w.reduce((P,O)=>P+(O.calories||0),0);return`
              <div class="meal-group card-glass" style="margin-bottom:var(--space-sm);">
                <div class="meal-group-header" data-meal-toggle="${x}">
                  ...
                  <span class="meal-group-cal">${w.length>0?Math.round(M)+" kcal":""}</span>
                </div>
    ...
    `,S()}function $(c){const d=c.productId?R(c.productId):null,l=(d==null?void 0:d.photo)||c.productPhotoBackup,v=(d==null?void 0:d.name)||c.productNameBackup||"Produit inconnu";return`
    ...
    `}function S(){var c,d,l,v,u;(c=e.querySelector("#btn-date-prev"))==null||c.addEventListener("click",()=>{const n=new Date(i+"T12:00:00");n.setDate(n.getDate()-1),i=n.toISOString().split("T")[0],g()}),(d=e.querySelector("#btn-date-next"))==null||d.addEventListener("click",()=>{const n=new Date(i+"T12:00:00");n.setDate(n.getDate()+1);const t=n.toISOString().split("T")[0];t<=a&&(i=t,g())}),(l=e.querySelector("#btn-date-today"))==null||l.addEventListener("click",()=>{i=a,g()}),(v=e.querySelector("#btn-add-food"))==null||v.addEventListener("click",()=>{B("products",["select"])}),e.querySelectorAll("[data-add-meal]").forEach(n=>{n.addEventListener("click",()=>{const t=n.dataset.addMeal;B("products",["select",t])})}),(u=e.querySelector("#btn-export"))==null||u.addEventListener("click",()=>{const n=Se(i);if(navigator.clipboard)navigator.clipboard.writeText(n).then(()=>{k("Résumé copié dans le presse-papiers ! 📋","success")});else{const t=document.createElement("textarea");t.value=n,document.body.appendChild(t),t.select(),document.execCommand("copy"),document.body.removeChild(t),k("Résumé copié ! 📋","success")}}),e.querySelectorAll("[data-edit-consumption]").forEach(n=>{n.addEventListener("click",t=>{t.stopPropagation();const o=n.dataset.editConsumption;E(o)})}),e.querySelectorAll("[data-delete-consumption]").forEach(n=>{n.addEventListener("click",t=>{t.stopPropagation();const o=n.dataset.deleteConsumption;confirm("Supprimer ce repas ?")&&(be(o),k("Repas supprimé","info"),g())})})}function E(c){const{getConsumption:d}=f(),l=d(c);if(!l)return;const v=l.productId?R(l.productId):null,u=l.productId&&!v,n=(v==null?void 0:v.name)||l.productNameBackup||"Produit inconnu",t=(v==null?void 0:v.caloriesPer100g)||l.caloriesPer100gBackup||0,o=document.createElement("div");o.className="modal-overlay",o.innerHTML=`
    ...
    `,document.body.appendChild(o);const m=o.querySelector("#edit-grams"),b=o.querySelector("#edit-cal-preview");m&&b&&!u&&m.addEventListener("input",()=>{const h=parseFloat(m.value)||0;b.textContent=Math.round(t*h/100)+" kcal"});const p=()=>o.remove();o.querySelector("#modal-close-edit").addEventListener("click",p),o.addEventListener("click",h=>{h.target===o&&p()}),o.querySelector("#btn-save-edit").addEventListener("click",()=>{parseFloat(m.value),o.querySelector("#edit-notes").value,u&&parseFloat(o.querySelector("#edit-calories").value),k("Consommation modifiée ✅","success"),p(),g()})}function f(){return{getConsumption:c=>N().find(d=>d.id===c),updateConsumption:(c,d)=>{},getProduct:R}}const L=X("consumptions:updated",()=>g());return r.push(L),g(),()=>{r.forEach(c=>c())}}const Pe="modulepreload",qe=function(e){return"/trackercal/"+e},oe={},de=function(s,a,i){let r=Promise.resolve();if(a&&a.length>0){let $=function(f){return Promise.all(f.map(L=>Promise.resolve(L).then(c=>({status:"fulfilled",value:c}),c=>({status:"rejected",reason:c}))))};document.getElementsByTagName("link");const S=document.querySelector("meta[property=csp-nonce]"),E=(S==null?void 0:S.nonce)||(S==null?void 0:S.getAttribute("nonce"));r=$(a.map(f=>{if(f=qe(f),f in oe)return;oe[f]=!0;const L=f.endsWith(".css"),c=L?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${f}"]${c}`))return;const d=document.createElement("link");if(d.rel=L?"stylesheet":Pe,L||(d.as="script"),d.crossOrigin="",d.href=f,E&&d.setAttribute("nonce",E),document.head.appendChild(d),L)return new Promise((l,v)=>{d.addEventListener("load",l),d.addEventListener("error",()=>v(new Error(`Unable to preload CSS for ${f}`)))})}))}function g($){const S=new Event("vite:preloadError",{cancelable:!0});if(S.payload=$,window.dispatchEvent(S),!S.defaultPrevented)throw $}return r.then($=>{for(const S of $||[])S.status==="rejected"&&g(S.reason);return s().catch(g)})};async function Me(e){try{const s=await fetch(`https://world.openfoodfacts.org/api/v2/product/${e}`,{headers:{"User-Agent":"MonSuiviCalories/1.0"}});if(!s.ok)return null;const a=await s.json();if(a.status!==1||!a.product)return null;const i=a.product;let r=0;const g=i.nutriments||{};return g["energy-kcal_100g"]?r=parseFloat(g["energy-kcal_100g"]):g["energy-kcal"]?r=parseFloat(g["energy-kcal"]):g.energy_100g?r=Math.round(ae(parseFloat(g.energy_100g))):g.energy&&(r=Math.round(ae(parseFloat(g.energy)))),{name:i.product_name||i.product_name_fr||"Produit inconnu",image:i.image_front_url||i.image_front_small_url||null,caloriesPer100g:Math.round(r),brand:i.brands||"",barcode:e}}catch(s){return console.error("Erreur API Open Food Facts:",s),null}}function Ce(e,s=[]){const a=s[0]==="select",i=s[1]||null;let r="";const g=[];function $(){const n=V(),t=r?n.filter(o=>o.name.toLowerCase().includes(r.toLowerCase())):n;e.innerHTML=`
    ...
    `,document.body.appendChild(o);let m=(t==null?void 0:t.photo)||null;const b=o.querySelector("#photo-input"),p=o.querySelector("#photo-upload-area");b.addEventListener("change",x=>{const y=x.target.files[0];if(!y)return;const w=new FileReader;w.onload=M=>{const P=new Image;P.onload=()=>{const O=document.createElement("canvas"),z=400;let j=P.width,T=P.height;j>T?j>z&&(T*=z/j,j=z):T>z&&(j*=z/T,T=z),O.width=j,O.height=T,O.getContext("2d").drawImage(P,0,0,j,T),m=O.toDataURL("image/jpeg",.7);let _=p.querySelector("img");_||(_=document.createElement("img"),p.appendChild(_)),_.src=m,_.alt="Photo",p.querySelector(".photo-upload-icon").style.display="none",p.querySelector(".photo-upload-text").style.display="none"},P.src=M.target.result},w.readAsDataURL(y)});const h=()=>o.remove();o.querySelector("#modal-close-product").addEventListener("click",h),o.addEventListener("click",x=>{x.target===o&&h()}),o.querySelector("#btn-save-product").addEventListener("click",()=>{const x=o.querySelector("#prod-name").value.trim(),y=o.querySelector("#prod-desc").value.trim(),w=parseFloat(o.querySelector("#prod-cal").value);if(!x){k("Veuillez entrer un nom","warning");return}if(isNaN(w)||w<0){k("Veuillez entrer des calories valides","warning");return}t?(me(n,{name:x,description:y,caloriesPer100g:w,photo:m}),k("Produit modifié ✅","success")):(ee({name:x,description:y,caloriesPer100g:w,photo:m}),k("Produit ajouté au catalogue ! 🎉","success")),h(),$()})}function L(n){const t=R(n);if(!t)return;const o=document.createElement("div");o.className="modal-overlay",o.innerHTML=`
      <div class="modal-content">
        <div class="modal-handle"></div>
    ...
    `,document.body.appendChild(o);let m=i||"collation";const b=o.querySelector("#cons-grams"),p=o.querySelector("#cal-preview");function h(){const y=parseFloat(b.value)||0,w=te(t.caloriesPer100g,y);p.textContent=Math.round(w)}b.addEventListener("input",h),o.querySelectorAll("[data-quick-gram]").forEach(y=>{y.addEventListener("click",()=>{b.value=y.dataset.quickGram,o.querySelectorAll(".btn-quick-gram").forEach(w=>w.classList.remove("active")),y.classList.add("active"),h()})}),o.querySelectorAll("[data-meal]").forEach(y=>{y.addEventListener("click",()=>{m=y.dataset.meal,o.querySelectorAll("[data-meal]").forEach(w=>w.classList.remove("active")),y.classList.add("active")})});const x=()=>o.remove();o.querySelector("#modal-close-consumption").addEventListener("click",x),o.addEventListener("click",y=>{y.target===o&&x()}),o.querySelector("#btn-confirm-consumption").addEventListener("click",()=>{const y=parseFloat(b.value)||0;if(y<=0){k("Veuillez entrer une quantité valide","warning");return}const w=te(t.caloriesPer100g,y),M=o.querySelector("#cons-notes").value.trim();ge({productId:t.id,productNameBackup:t.name,productPhotoBackup:t.photo,caloriesPer100gBackup:t.caloriesPer100g,grams:y,calories:w,meal:m,notes:M}),k(`${t.name} – ${Math.round(w)} kcal ajouté ! ✅`,"success"),x(),B("dashboard")})}async function c(){let n;try{n=(await de(()=>import("./index-C7szoz8K.js"),[])).Html5Qrcode}catch{k("Scanner non disponible","error"),d();return}const t=document.createElement("div");t.className="modal-overlay",t.style.alignItems="center",t.innerHTML=`
    ...
    `,document.body.appendChild(n);const t=()=>n.remove();n.querySelector("#modal-close-manual").addEventListener("click",t),n.addEventListener("click",o=>{o.target===n&&t()}),n.querySelector("#btn-search-barcode").addEventListener("click",async()=>{const o=n.querySelector("#manual-barcode").value.trim();if(!o){k("Veuillez entrer un code-barres","warning");return}t(),await l(o)})}async function l(n){k("Recherche en cours...","info",2e3);const t=await Me(n);if(!t){k("Produit non trouvé dans la base Open Food Facts","error");return}v(t)}function v(n){const t=document.createElement("div");t.className="modal-overlay",t.innerHTML=`
      <div class="modal-content">
        <div class="modal-handle"></div>
    ...
    `,document.body.appendChild(t);const o=()=>t.remove();t.querySelector("#modal-close-result").addEventListener("click",o),t.addEventListener("click",m=>{m.target===t&&o()}),t.querySelector("#btn-add-barcode-product").addEventListener("click",()=>{ee({name:n.name,description:n.brand||"",caloriesPer100g:n.caloriesPer100g,photo:n.image||null}),k("Produit ajouté au catalogue ! 🎉","success"),o(),$()})}const u=X("products:updated",()=>$());return g.push(u),$(),()=>{g.forEach(n=>n())}}function je(e){const s=U(),a=(s==null?void 0:s.dailyTarget)||2e3;let i="jour",r=null;function g(){e.innerHTML=`
    ...
    `,$(),f(),L()}function $(){e.querySelectorAll("[data-filter]").forEach(c=>{c.addEventListener("click",()=>{i=c.dataset.filter,g()})})}function S(){const c=new Date;c.setHours(12,0,0,0);let d,l;switch(i){case"jour":{d=new Date(c),d.setDate(d.getDate()-6),l=new Date(c);break}case"semaine":{d=new Date(c),d.setDate(d.getDate()-27),l=new Date(c);break}case"mois":{d=new Date(c),d.setMonth(d.getMonth()-5),d.setDate(1),l=new Date(c);break}}return{start:d.toISOString().split("T")[0],end:l.toISOString().split("T")[0]}}function E(){const{start:c,end:d}=S(),l=fe(c,d),v={};if(l.forEach(u=>{v[u.date]||(v[u.date]=0),v[u.date]+=u.calories||0}),i==="jour"){const u=[],n=[],t=new Date;t.setHours(12,0,0,0);for(let o=6;o>=0;o--){const m=new Date(t);m.setDate(m.getDate()-o);const b=m.toISOString().split("T")[0],p=m.toLocaleDateString("fr-FR",{weekday:"short",day:"numeric"});u.push(p),n.push(Math.round(v[b]||0))}return{labels:u,values:n}}if(i==="semaine"){const u=[],n=[],t=new Date;t.setHours(12,0,0,0);for(let o=3;o>=0;o--){const m=new Date(t);m.setDate(m.getDate()-o*7);const b=new Date(m);b.setDate(b.getDate()-6);let p=0,h=0;for(let w=0;w<=6;w++){const M=new Date(b);M.setDate(M.getDate()+w);const P=M.toISOString().split("T")[0];v[P]&&(p+=v[P],h++)}const x=h>0?Math.round(p/h):0,y=b.toLocaleDateString("fr-FR",{day:"numeric",month:"short"});u.push(`Sem. ${y}`),n.push(x)}return{labels:u,values:n}}if(i==="mois"){const u=[],n=[],t=new Date;for(let o=5;o>=0;o--){const m=new Date(t.getFullYear(),t.getMonth()-o,1),b=new Date(t.getFullYear(),t.getMonth()-o+1,0);let p=0,h=0;for(let y=1;y<=b.getDate();y++){const w=`${m.getFullYear()}-${String(m.getMonth()+1).padStart(2,"0")}-${String(y).padStart(2,"0")}`;v[w]&&(p+=v[w],h++)}const x=h>0?Math.round(p/h):0;u.push(m.toLocaleDateString("fr-FR",{month:"short"})),n.push(x)}return{labels:u,values:n}}return{labels:[],values:[]}}async function f(){const c=e.querySelector("#calorie-chart");if(!c)return;const{labels:d,values:l}=E();let v;try{const p=await de(()=>import("./chart-45xamTTr.js"),[]);v=p.Chart;const{CategoryScale:h,LinearScale:x,BarElement:y,LineElement:w,PointElement:M,Title:P,Tooltip:O,Legend:z,BarController:j,LineController:T}=p;v.register(h,x,y,w,M,P,O,z,j,T)}catch(p){console.error("Chart.js not available:",p),c.parentElement.innerHTML='<p style="text-align:center;color:var(--text-tertiary);padding:var(--space-lg);">Graphique non disponible</p>';return}r&&r.destroy();const u=c.getContext("2d");l.map(p=>p>a);const n=getComputedStyle(document.documentElement),t=n.getPropertyValue("--text-secondary").trim()||"#6B4D5A",o=n.getPropertyValue("--accent").trim()||"#E91E8C",m="#F44336",b=n.getPropertyValue("--divider").trim()||"rgba(0,0,0,0.06)";r=new v(u,{type:i==="jour"?"bar":"line",data:{labels:d,datasets:[{label:i==="jour"?"Calories":"Moy. calories",data:l,backgroundColor:l.map(p=>p>a?"rgba(244, 67, 54, 0.6)":"rgba(233, 30, 140, 0.5)"),borderColor:l.map(p=>p>a?m:o),borderWidth:2,borderRadius:i==="jour"?8:0,tension:.4,fill:i!=="jour",pointBackgroundColor:o,pointRadius:i!=="jour"?4:0}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1},tooltip:{backgroundColor:"rgba(0,0,0,0.8)",titleColor:"#fff",bodyColor:"#fff",cornerRadius:8,padding:12,callbacks:{label:p=>`${p.raw} kcal`}}},scales:{x:{grid:{display:!1},ticks:{color:t,font:{size:11}}},y:{grid:{color:b},ticks:{color:t,font:{size:11}},beginAtZero:!0}},annotation:{annotations:{targetLine:{type:"line",yMin:a,yMax:a,borderColor:"rgba(255, 152, 0, 0.5)",borderWidth:2,borderDash:[5,5]}}}}})}function L(){const c=e.querySelector("#history-details");if(!c)return;const d=new Date;d.setHours(12,0,0,0);const l=i==="jour"||i==="semaine"?7:30;let v="";for(let u=0;u<l;u++){const n=new Date(d);n.setDate(n.getDate()-u);const t=n.toISOString().split("T")[0],o=N(t),m=o.reduce((h,x)=>h+(x.calories||0),0);if(o.length===0)continue;const b=m>a,p=u===0?"Aujourd'hui":u===1?"Hier":n.toLocaleDateString("fr-FR",{weekday:"long",day:"numeric",month:"long"});v+=`
        <div class="card-glass mb-sm history-day-card" data-day="${t}">
          ...
          <div class="history-day-items" id="day-items-${t}" style="display:none;margin-top:var(--space-sm);">
            ${o.map(h=>{const x=h.productId?R(h.productId):null;return`
                <div class="consumption-item" style="padding:var(--space-xs) 0;">
                  <div class="consumption-item-info">
                    <div class="consumption-item-name" style="font-size:var(--font-xs);">${(x==null?void 0:x.name)||h.productNameBackup||"Produit inconnu"}</div>
      ...
      `),c.innerHTML=v,c.querySelectorAll("[data-toggle-day]").forEach(u=>{u.addEventListener("click",()=>{const n=u.dataset.toggleDay,t=c.querySelector(`#day-items-${n}`);t&&(t.style.display=t.style.display==="none"?"block":"none")})})}return g(),()=>{r&&(r.destroy(),r=null)}}function Te(e){const s=U();Z();let a=!1,i=s?{...s}:{};function r(){const E=J();e.innerHTML=`
    ...
    `,S()}function g(){if(!s)return'<p class="text-secondary">Aucun profil configuré</p>';const E=s.sex==="homme"?"👨 Homme":"👩 Femme",f={sedentary:"Sédentaire",light:"Léger",moderate:"Modéré",active:"Actif","very-active":"Très actif"};return`
      <div class="profile-summary">
        ...
        <div class="flex-between">
          ...
          <strong>${f[s.activityLevel]||"Sédentaire"}</strong>
        </div>
      </div>
    ...
    `}function S(){var f,L,c,d,l,v,u,n;(f=e.querySelector("#btn-toggle-edit"))==null||f.addEventListener("click",()=>{a=!a,a&&s&&(i={...s}),r()}),e.querySelectorAll("[data-edit-sex]").forEach(t=>{t.addEventListener("click",()=>{i.sex=t.dataset.editSex,r()})}),e.querySelectorAll("[data-edit-activity]").forEach(t=>{t.addEventListener("click",()=>{i.activityLevel=t.dataset.editActivity,r()})});const E={"edit-age":"age","edit-height":"height","edit-weight":"weight","edit-goal":"goalWeight","edit-duration":"duration"};for(const[t,o]of Object.entries(E))(L=e.querySelector(`#${t}`))==null||L.addEventListener("input",m=>{i[o]=m.target.value});(c=e.querySelector("#btn-save-profile"))==null||c.addEventListener("click",()=>{const t={...i,age:parseInt(i.age),weight:parseFloat(i.weight),height:parseInt(i.height)||170,goalWeight:parseFloat(i.goalWeight),duration:parseInt(i.duration)},o=Q(t);le({...t,bmr:o.bmr,tdee:o.tdee,dailyDeficit:o.dailyDeficit,dailyTarget:o.dailyTarget}),a=!1,k("Profil mis à jour ! Objectif recalculé.","success"),r()}),(d=e.querySelector("#btn-toggle-theme"))==null||d.addEventListener("click",()=>{const o=J()==="light"?"dark":"light";ye(o),r()}),(l=e.querySelector("#btn-clear-data"))==null||l.addEventListener("click",()=>{confirm("Êtes-vous sûr(e) de vouloir supprimer toutes les données ? Cette action est irréversible.")&&($e(),k("Toutes les données ont été supprimées","info"),window.location.hash="",window.location.reload())}),(v=e.querySelector("#btn-export-data"))==null||v.addEventListener("click",()=>{try{const t=xe(),o=new Blob([JSON.stringify(t,null,2)],{type:"application/json"}),m=URL.createObjectURL(o),b=document.createElement("a"),p=new Date().toISOString().split("T")[0];b.href=m,b.download=`trackercal-backup-${p}.json`,document.body.appendChild(b),b.click(),document.body.removeChild(b),URL.revokeObjectURL(m),k("Sauvegarde créée avec succès !","success")}catch{k("Erreur lors de l'exportation","error")}}),(u=e.querySelector("#btn-import-data"))==null||u.addEventListener("click",()=>{var t;(t=e.querySelector("#file-import"))==null||t.click()}),(n=e.querySelector("#file-import"))==null||n.addEventListener("change",async t=>{var m;const o=(m=t.target.files)==null?void 0:m[0];if(o){try{const b=await o.text(),p=JSON.parse(b);if(!p.version)throw new Error("Format invalide");confirm("Cette action remplacera toutes vos données actuelles. Voulez-vous continuer ?")&&(we(p),k("Données importées avec succès !","success"),setTimeout(()=>window.location.reload(),1500))}catch{k("Erreur : fichier invalide","error")}t.target.value=""}})}return r(),()=>{}}const K=document.getElementById("app");let ue=null,I=null;const Ie=[{id:"dashboard",icon:"🏠",label:"Accueil"},{id:"products",icon:"🍎",label:"Produits"},{id:"history",icon:"📊",label:"Historique"},{id:"settings",icon:"⚙️",label:"Réglages"}];function Oe(){const e=J();document.documentElement.setAttribute("data-theme",e),window.addEventListener("hashchange",ie),ce()?ie():Y("onboarding"),X("profile:updated",()=>{ue==="onboarding"&&B("dashboard")})}function ie(){if(!ce()){Y("onboarding");return}const e=window.location.hash.slice(1)||"dashboard",[s,...a]=e.split("/");Y(s,a)}function B(e,s=[]){const a=s.length?`${e}/${s.join("/")}`:e;window.location.hash=a}function Y(e,s=[]){I&&(I(),I=null),ue=e;const a=document.createElement("div");switch(a.className="view-container view-enter",a.id="view-container",K.innerHTML="",K.appendChild(a),e){case"onboarding":I=De(a);break;case"dashboard":I=ne(a),W("dashboard");break;case"products":I=Ce(a,s),W("products");break;case"history":I=je(a),W("history");break;case"settings":I=Te(a),W("settings");break;default:I=ne(a),W("dashboard")}}function W(e){const s=document.querySelector(".nav-bar");s&&s.remove();const a=document.createElement("nav");a.className="nav-bar",a.innerHTML=Ie.map(i=>`
    <button class="nav-item ${i.id===e?"active":""}" data-view="${i.id}" aria-label="${i.label}">
      <span class="nav-item-icon">${i.icon}</span>
      <span>${i.label}</span>
    </button>
  `).join(""),a.addEventListener("click",i=>{const r=i.target.closest(".nav-item");if(!r)return;const g=r.dataset.view;B(g)}),K.appendChild(a)}Oe();
